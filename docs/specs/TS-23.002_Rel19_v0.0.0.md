> **TS-23.002_Rel19_v0.0.0** — converted from official 3GPP archive.
> Source: https://www.3gpp.org/ftp/Specs/archive/23_series/23.002/23002-j00.zip
...
<thead>
<tr>
<th colspan="2">3GPP TS 23.002 V19.0.0 (2025-09)</th>
</tr>
</thead>
<tbody>
<tr>
...
3 Definitions and abbreviations [19](#definitions-and-abbreviations)

3.1 Public Land Mobile Network (PLMN) [19](#public-land-mobile-network-plmn)

3.2 Core Network (CN) and Access Network (AN) [19](#core-network-cn-and-access-network-an)

3.3 Circuit Switched (CS) and Packet Switched (PS) Domains [19](#circuit-switched-cs-and-packet-switched-ps-domains)

3.3.1 CS Domain [20](#cs-domain)

3.3.2 PS Domain [20](#ps-domain)

3.3a IP Multimedia subsystem (IMS) [20](#a-ip-multimedia-subsystem-ims)

3.4 Location register [20](#location-register)

3.5 Cell [21](#cell)

3.6 Base Station Controller (BSC) area [21](#base-station-controller-bsc-area)

3.7 Radio Network Controller (RNC) area [21](#radio-network-controller-rnc-area)

3.8 Location Area (LA) [21](#location-area-la)

3.9 Routing Area (RA) [21](#routing-area-ra)

3.9a Tracking Area (TA) [21](#a-tracking-area-ta)

3.10 MSC area [21](#msc-area)

3.11 VLR area [21](#vlr-area)

3.12 SGSN area [22](#sgsn-area)

3.13 Zones for Regional Subscription [22](#zones-for-regional-subscription)

3.14 Service area [22](#service-area)

3.15 Group call area [22](#group-call-area)

3.15a MME Area [22](#a-mme-area)

3.16 Pool-area [22](#pool-area)

3.17 Serving GW Service Area [22](#serving-gw-service-area)

4 The basic entities of the mobile system [23](#the-basic-entities-of-the-mobile-system)

4.1 The Core Network (CN) entities [23](#the-core-network-cn-entities)

4.1.1 Entities common to the PS and CS domains [23](#entities-common-to-the-ps-and-cs-domains)

4.1.1.1 The Home Subscriber Server (HSS) [23](#the-home-subscriber-server-hss)

4.1.1.1.1 The Home Location Register (HLR) [24](#the-home-location-register-hlr)

4.1.1.1.2 The Authentication Centre (AuC) [24](#the-authentication-centre-auc)

4.1.1.1.3 HSS logical functions [25](#hss-logical-functions)

4.1.1.2 The Visitor Location Register (VLR) [26](#the-visitor-location-register-vlr)

4.1.1.3 (void) [27](#void)

4.1.1.4 The Equipment Identity Register (EIR) [27](#the-equipment-identity-register-eir)

4.1.1.5 SMS Gateway MSC (SMS-GMSC) [27](#sms-gateway-msc-sms-gmsc)

4.1.1.6 SMS Interworking MSC (SMS-IWMSC) [27](#sms-interworking-msc-sms-iwmsc)

4.1.1.7 Subscription Locator Function (SLF) [27](#subscription-locator-function-slf)

4.1.2 Entities of the CS domain [28](#entities-of-the-cs-domain)

4.1.2.1 The Mobile-services Switching Centre (MSC) [28](#the-mobile-services-switching-centre-msc)

4.1.2.1.1 MSC Server [28](#msc-server)

4.1.2.1.2 Circuit Switched - Media Gateway Function (CS-MGW) [29](#circuit-switched---media-gateway-function-cs-mgw)

4.1.2.2 The Gateway MSC (GMSC) [29](#the-gateway-msc-gmsc)

4.1.2.2.1 Gateway MSC Server (GMSC Server) [29](#gateway-msc-server-gmsc-server)

4.1.2.3 The Interworking Function (IWF) [29](#the-interworking-function-iwf)

4.1.3 Entities of the GPRS PS domain [30](#entities-of-the-gprs-ps-domain)

4.1.3.1 Serving GPRS Support Node (SGSN) [30](#serving-gprs-support-node-sgsn)

4.1.3.2 Gateway GPRS Support Node (GGSN) [30](#gateway-gprs-support-node-ggsn)

4.1.3.3 Void [31](#void-1)

4.1.4 Entities of the EPC PS Domain [31](#entities-of-the-epc-ps-domain)

4.1.4.1 MME [31](#mme)

4.1.4.2 Gateways [32](#gateways)

4.1.4.2.1 Serving GW [32](#serving-gw)

4.1.4.2.2 PDN GW [32](#pdn-gw)

4.1.4.2.3 Local GW (L-GW) [33](#local-gw-l-gw)

4.1.4.3 SGSN [33](#sgsn)

4.1.4.4 Trusted and Untrusted Non-3GPP Access Network [33](#trusted-and-untrusted-non-3gpp-access-network)

4.1.4.5 ePDG [34](#epdg)

4.1.4.6 3GPP AAA Server [34](#gpp-aaa-server)

4.1.4.7 3GPP AAA Proxy [34](#gpp-aaa-proxy)

4.1.4.8 ANDSF [34](#andsf)

4.1.5 Border Gateway (BG)\] [35](#border-gateway-bg)

4.2 The Access Network (AN) entities [35](#the-access-network-an-entities)

4.2.1 The Base Station System (BSS) [35](#the-base-station-system-bss)

4.2.1.1 Base Station Controller (BSC) [35](#base-station-controller-bsc)

4.2.1.2 Base Transceiver Station (BTS) [36](#base-transceiver-station-bts)

4.2.2 The Radio Network System (RNS) [36](#the-radio-network-system-rns)

4.2.2.1 Radio Network Controller (RNC) [36](#radio-network-controller-rnc)

4.2.2.2 Node B [36](#node-b)

4.2.3 Access Network elements for E-UTRAN [36](#access-network-elements-for-e-utran)

4.2.3.1 E-UTRAN Node B (eNodeB) [36](#e-utran-node-b-enodeb)

4.2.3.2 Evolved UTRAN [36](#evolved-utran)

4.3 The Mobile Station (MS) [36](#the-mobile-station-ms)

4.4 User Equipment (UE) [37](#user-equipment-ue)

4a The specific entities of the 3GPP system [37](#a-the-specific-entities-of-the-3gpp-system)

4a.1 The Group Call Register (GCR) entity [37](#a.1-the-group-call-register-gcr-entity)

4a.2 (void) [38](#a.2-void)

4a.3 The Location Services (LCS) entities [38](#a.3-the-location-services-lcs-entities)

4a.3.1 Location Services (LCS) entities in RAN [38](#a.3.1-location-services-lcs-entities-in-ran)

4a.3.2 Gateway Mobile Location Centre (GMLC) [39](#a.3.2-gateway-mobile-location-centre-gmlc)

4a.3.3 Location Measurement Unit (LMU) [39](#a.3.3-location-measurement-unit-lmu)

4a.3.4 Evolved Serving Mobile Location Centre (E-SMLC) [39](#a.3.4-evolved-serving-mobile-location-centre-e-smlc)

4a.4 CAMEL entities [40](#a.4-camel-entities)

4a.4.1 GSM Service Control Function (gsmSCF) [40](#a.4.1-gsm-service-control-function-gsmscf)

4a.4.2 GSM Service Switching Function (gsmSSF) [40](#a.4.2-gsm-service-switching-function-gsmssf)

4a.4.3 GSM Specialised Resource Function (gsmSRF) [40](#a.4.3-gsm-specialised-resource-function-gsmsrf)

4a.4.4 GPRS Service Switching Function (gprsSSF) [40](#a.4.4-gprs-service-switching-function-gprsssf)

4a.5 CBS-specific entities [40](#a.5-cbs-specific-entities)

4a.5.1 Cell Broadcast Centre (CBC) [40](#a.5.1-cell-broadcast-centre-cbc)

4a.6 Number Portability Specific entities [40](#a.6-number-portability-specific-entities)

4a.6.1 IN-based solution: Number Portability Database (NPDB) [40](#a.6.1-in-based-solution-number-portability-database-npdb)

4a.6.2 Signalling Relay-based solution: Mobile Number Portability/Signalling Relay function (MNP-SRF) [41](#a.6.2-signalling-relay-based-solution-mobile-number-portabilitysignalling-relay-function-mnp-srf)

4a.7 IP Multimedia (IM) Core Network (CN) Subsystem entities [41](#a.7-ip-multimedia-im-core-network-cn-subsystem-entities)

4a.7.1 Call Session Control Function (CSCF) [41](#a.7.1-call-session-control-function-cscf)

4a.7.2 Media Gateway Control Function (MGCF) [41](#a.7.2-media-gateway-control-function-mgcf)

4a.7.3 IP Multimedia Subsystem - Media Gateway Function (IMS-MGW) [41](#a.7.3-ip-multimedia-subsystem---media-gateway-function-ims-mgw)

4a.7.4 Multimedia Resource Function Controller (MRFC) [42](#a.7.4-multimedia-resource-function-controller-mrfc)

4a.7.4a Multimedia Resource Function Processor (MRFP) [42](#a.7.4a-multimedia-resource-function-processor-mrfp)

4a.7.4b Media Resource Broker (MRB) [42](#a.7.4b-media-resource-broker-mrb)

4a.7.5 Void [42](#a.7.5-void)

4a.7.6 Breakout Gateway Control Function (BGCF) [42](#a.7.6-breakout-gateway-control-function-bgcf)

4a.7.7 Application Server (AS) [43](#a.7.7-application-server-as)

4a.7.8 Interconnection Border Control Function (IBCF) [43](#a.7.8-interconnection-border-control-function-ibcf)

4a.7.9 Transition Gateway (TrGW) [43](#a.7.9-transition-gateway-trgw)

4a.7.10 Location Retrieval Function (LRF) [43](#a.7.10-location-retrieval-function-lrf)

4a.7.11 Service Centralization and Continuity Application Server (SCC AS) [44](#a.7.11-service-centralization-and-continuity-application-server-scc-as)

4a.7.11a Emergency Access Transfer Function (EATF) [44](#a.7.11a-emergency-access-transfer-function-eatf)

4a.7.12 Access Transfer Control Function (ATCF) [44](#a.7.12-access-transfer-control-function-atcf)

4a.7.13 Access Transfer Gateway (ATGW) [44](#a.7.13-access-transfer-gateway-atgw)

4a.8 Signalling Gateway Function (SGW) [44](#a.8-signalling-gateway-function-sgw)

4a.9 Global Text Telephony Specific entities [44](#a.9-global-text-telephony-specific-entities)

4a.10 Security Gateway (SEG) [44](#a.10-security-gateway-seg)

4a.11 Application Function (AF) [45](#a.11-application-function-af)

4a.12 Void [45](#a.12-void)

4a.13 3GPP/WLAN Interworking entities [45](#a.13-3gppwlan-interworking-entities)

4a.13.1 WLAN UE [45](#a.13.1-wlan-ue)

4a.13.2 3GPP AAA Proxy [45](#a.13.2-3gpp-aaa-proxy)

4a.13.3 3GPP AAA Server [45](#a.13.3-3gpp-aaa-server)

4a.13.4 WLAN Access Gateway (WAG) [45](#a.13.4-wlan-access-gateway-wag)

4a.13.5 Packet Data Gateway (PDG) [45](#a.13.5-packet-data-gateway-pdg)

4a.13.6 Home Agent (HA) [45](#a.13.6-home-agent-ha)

4a.14 Multimedia Broadcast Multicast Service (MBMS) specific entities [45](#a.14-multimedia-broadcast-multicast-service-mbms-specific-entities)

4a.14.1 General [45](#a.14.1-general)

4a.14.2 Broadcast-Multicast Service Centre (BM-SC) [46](#a.14.2-broadcast-multicast-service-centre-bm-sc)

4a.14.3 MBMS‑GW [46](#a.14.3-mbmsgw)

4a.14.4 Multi-cell/multicast Coordination Entity (MCE) [46](#a.14.4-multi-cellmulticast-coordination-entity-mce)

4a.15 Void [46](#a.15-void)

4a.16 GUP Server [46](#a.16-gup-server)

4a.17 Policy and Charging Rules Function (PCRF) [46](#a.17-policy-and-charging-rules-function-pcrf)

4a.18 Policy and Charging Enforcement Function (PCEF) [47](#a.18-policy-and-charging-enforcement-function-pcef)

4a.19 Support of Short Message Service over generic 3GPP Internet Protocol access (SMSIP) specific entities [47](#a.19-support-of-short-message-service-over-generic-3gpp-internet-protocol-access-smsip-specific-entities)

4a.19.1 General [47](#a.19.1-general)

4a.19.2 IP-Short-Message-Gateway (IP-SM-GW) [47](#a.19.2-ip-short-message-gateway-ip-sm-gw)

4a.20 Subscription Profile Repository (SPR) [47](#a.20-subscription-profile-repository-spr)

4a.21 Service Data Flow Based Credit Control Function [47](#a.21-service-data-flow-based-credit-control-function)

4a.22 Offline Charging System (OFCS) [47](#a.22-offline-charging-system-ofcs)

4a.23 Online Charging System (OCS) [47](#a.23-online-charging-system-ocs)

4a.24 Bearer Binding and Event Reporting Function (BBERF) [47](#a.24-bearer-binding-and-event-reporting-function-bberf)

4a.25 Home (e)NodeB entities [48](#a.25-home-enodeb-entities)

4a.25.1 Home NodeB Subsystem (HNS) [48](#a.25.1-home-nodeb-subsystem-hns)

4a.25.2 Home eNodeB Subsystem (HeNS) [48](#a.25.2-home-enodeb-subsystem-hens)

4a.25.3 CSG List Server [48](#a.25.3-csg-list-server)

4a.25.4 CSG Subscriber Server (CSS) [48](#a.25.4-csg-subscriber-server-css)

4a.26 Application Front Ends (AFE) [49](#a.26-application-front-ends-afe)

4a.27 User Data Repository (UDR) [49](#a.27-user-data-repository-udr)

4a.28 Traffic Detection Function (TDF) [49](#a.28-traffic-detection-function-tdf)

4a.29 Specific entities to facilitate communications with packet data networks and applications [49](#a.29-specific-entities-to-facilitate-communications-with-packet-data-networks-and-applications)

4a.29.1 Machine Type Communication-InterWorking Function (MTC-IWF) [49](#a.29.1-machine-type-communication-interworking-function-mtc-iwf)

4a.29.2 Machine Type Communication- Authentication, Authorization and Accounting (MTC-AAA) [49](#a.29.2-machine-type-communication--authentication-authorization-and-accounting-mtc-aaa)

4a.29.3 Service Capability Exposure Function (SCEF) [50](#a.29.3-service-capability-exposure-function-scef)

4a.30 TCP Proxy Function [50](#a.30-tcp-proxy-function)

4a.31 Specific entities for Packet Switched Streaming (PSS) Service [50](#a.31-specific-entities-for-packet-switched-streaming-pss-service)

4a.31.1 Packet Switched Streaming Service Server (PSS Server) [50](#a.31.1-packet-switched-streaming-service-server-pss-server)

4a.32 Specific entities for Group Communication System Enablers for LTE (GCSE_LTE) [50](#a.32-specific-entities-for-group-communication-system-enablers-for-lte-gcse_lte)

4a.32.1 Group Communication Service Application Server (GCS AS) [50](#a.32.1-group-communication-service-application-server-gcs-as)

4a.33 Specific entities for Proximity-based Services (ProSe) [50](#a.33-specific-entities-for-proximity-based-services-prose)

4a.33.1 ProSe Function [50](#a.33.1-prose-function)

4a.34 RAN Congestion Awareness Function (RCAF) [51](#a.34-ran-congestion-awareness-function-rcaf)

4a.35 Traffic Steering Support Function (TSSF) [51](#a.35-traffic-steering-support-function-tssf)

4a.36 Specific entities for mission critical communication services [51](#a.36-specific-entities-for-mission-critical-communication-services)

4a.36.1 Mission Critical Push To Talk Application Server (MCPTT AS) [51](#a.36.1-mission-critical-push-to-talk-application-server-mcptt-as)

4a.37 Packet Flow Description Function (PFDF) [51](#a.37-packet-flow-description-function-pfdf)

4a.38 5G System architecture [51](#a.38-5g-system-architecture)

5 Configuration of a Public Land Mobile Network [51](#configuration-of-a-public-land-mobile-network)

5.1 Basic configuration [51](#basic-configuration)

5.2 Configuration of LCS entities [56](#configuration-of-lcs-entities)

5.2.1 Configuration of LCS entities for GERAN [56](#configuration-of-lcs-entities-for-geran)

5.2.2 Configuration of LCS entities for UTRAN [57](#configuration-of-lcs-entities-for-utran)

5.2.3 Configuration of LCS entities for E-UTRAN [57](#configuration-of-lcs-entities-for-e-utran)

5.3 Configuration of CAMEL entities [58](#configuration-of-camel-entities)

5.4 Configuration of CBS entities [59](#configuration-of-cbs-entities)

5.5 Configuration of IM CN Subsystem entities [59](#configuration-of-im-cn-subsystem-entities)

5.5.1 IM CN Subsystem functional entities [59](#im-cn-subsystem-functional-entities)

5.5.2 IM CN Subsystem Service layer [60](#im-cn-subsystem-service-layer)

5.5.3 Service Centralization and Continuity [62](#service-centralization-and-continuity)

5.5.4 WebRTC access to IMS [63](#webrtc-access-to-ims)

5.6 Configuration of Signalling Gateway Function [64](#configuration-of-signalling-gateway-function)

5.7 Configuration of 3GPP/WLAN Interworking [64](#configuration-of-3gppwlan-interworking)

5.8 Configuration of Presence service [65](#configuration-of-presence-service)

5.9 Configuration of MBMS entities [65](#configuration-of-mbms-entities)

5.10 Configuration of Short Message Service over generic 3GPP Internet Protocol access (SMSIP) entities [67](#configuration-of-short-message-service-over-generic-3gpp-internet-protocol-access-smsip-entities)

5.11 Configuration of Policy Control and Charging entities [67](#configuration-of-policy-control-and-charging-entities)

5.12 Configuration of CSFB(CS Fallback) [70](#configuration-of-csfbcs-fallback)

5.13 Configuration of Single Radio Voice Call Continuity (SRVCC) [71](#configuration-of-single-radio-voice-call-continuity-srvcc)

5.13.1 E-UTRAN/UTRAN (HSPA) to UTRAN or GERAN SRVCC architecture [71](#e-utranutran-hspa-to-utran-or-geran-srvcc-architecture)

5.13.2 UTRAN/GERAN to E-UTRAN or UTRAN (HSPA) SRVCC architecture [72](#utrangeran-to-e-utran-or-utran-hspa-srvcc-architecture)

5.14 Configuration of Security [74](#configuration-of-security)

5.15 Configuration of Lawful Intercept related entities [74](#configuration-of-lawful-intercept-related-entities)

5.16 Configuration of Charging related entities [75](#configuration-of-charging-related-entities)

5.17 Configuration of Home (e)NodeB entities [76](#configuration-of-home-enodeb-entities)

5.17.1 Configuration of the Home NodeB Subsystem [76](#configuration-of-the-home-nodeb-subsystem)

5.17.2 Configuration of the Home eNodeB Subsystem [77](#configuration-of-the-home-enodeb-subsystem)

5.18 Configuration for facilitating communications with packet data networks and applications [78](#configuration-for-facilitating-communications-with-packet-data-networks-and-applications)

5.19 Configuration of Packet Switched Streaming (PSS) Service [78](#configuration-of-packet-switched-streaming-pss-service)

5.20 Configuration of Proximity-based Services [79](#configuration-of-proximity-based-services)

5.21 Configuration for RAN user plane congestion detection and reporting [79](#configuration-for-ran-user-plane-congestion-detection-and-reporting)

6 PLMN basic interfaces and reference points [80](#plmn-basic-interfaces-and-reference-points)

6.1 Interfaces between Mobile Station and the Fixed Infrastructure [80](#interfaces-between-mobile-station-and-the-fixed-infrastructure)

6.1.1 Interface between Mobile Station and Base Station System (Um-interface) [80](#interface-between-mobile-station-and-base-station-system-um-interface)

6.1.2 Interface between User Equipment and Radio Network System (Uu-interface) [80](#interface-between-user-equipment-and-radio-network-system-uu-interface)

6.1.3 Interface between User Equipment and Evolved UTRAN (E-UTRAN Uu-interface) [80](#interface-between-user-equipment-and-evolved-utran-e-utran-uu-interface)

6.2 Interface between the Core Network and the Access Network [80](#interface-between-the-core-network-and-the-access-network)

6.2.1 Interfaces between the CS domain and the Access Network [80](#interfaces-between-the-cs-domain-and-the-access-network)

6.2.1.1 Interface between the MSC and Base Station System (A-interface) [80](#interface-between-the-msc-and-base-station-system-a-interface)

6.2.1.2 Interface between the MSC and Base Station System (Iu_CS interface) [81](#interface-between-the-msc-and-base-station-system-iu_cs-interface)

6.2.1.3 Interface between the MSC and RNS (Iu_CS interface) [81](#interface-between-the-msc-and-rns-iu_cs-interface)

6.2.2 Interfaces between the PS domain and the Access Network [81](#interfaces-between-the-ps-domain-and-the-access-network)

6.2.2.1 Interface between SGSN and BSS (Gb-interface) [81](#interface-between-sgsn-and-bss-gb-interface)

6.2.2.2 Interface between SGSN and BSS (Iu_PS-interface) [81](#interface-between-sgsn-and-bss-iu_ps-interface)

6.2.2.3 Interface between SGSN and RNS (Iu_PS-interface) [81](#interface-between-sgsn-and-rns-iu_ps-interface)

6.2.3 Interfaces between the Evolved Packet Core and the Access Network [82](#interfaces-between-the-evolved-packet-core-and-the-access-network)

6.2.3.1 Interface between MME and E-UTRAN (S1-MME-interface) [82](#interface-between-mme-and-e-utran-s1-mme-interface)

6.2.3.2 Interface between S-GW and E-UTRAN (S1-U-interface) [82](#interface-between-s-gw-and-e-utran-s1-u-interface)

6.3 Interfaces internal to the Access Network [82](#interfaces-internal-to-the-access-network)

6.3.1 Interface between BSC and BTS (Abis-interface) [82](#interface-between-bsc-and-bts-abis-interface)

6.3.2 Interface between RNC and Node B (Iub-interface) [82](#interface-between-rnc-and-node-b-iub-interface)

6.3.3 Interface between two RNCs (Iur-interface) [82](#interface-between-two-rncs-iur-interface)

6.3.4 Interface between two eNBs (X2-interface) [82](#interface-between-two-enbs-x2-interface)

6.3.5 Interface between HNB and HNB-GW(Iuh-interface) [82](#interface-between-hnb-and-hnb-gwiuh-interface)

6.4 Interfaces internal to the Core Network [82](#interfaces-internal-to-the-core-network)

6.4.1 Interfaces internal to the CS domain [82](#interfaces-internal-to-the-cs-domain)

6.4.1.1 Interface between the MSC server and its associated VLR (B-interface) [82](#interface-between-the-msc-server-and-its-associated-vlr-b-interface)

6.4.1.2 Interface between the HLR and the MSC server (C-interface) [83](#interface-between-the-hlr-and-the-msc-server-c-interface)

6.4.1.3 Interface between the HLR and the VLR (D-interface) [83](#interface-between-the-hlr-and-the-vlr-d-interface)

6.4.1.4 Interface between MSC servers or MSC server and IP-SM-GW (E-interface) [83](#interface-between-msc-servers-or-msc-server-and-ip-sm-gw-e-interface)

6.4.1.5 Interface between MSC server and EIR (F-interface) [83](#interface-between-msc-server-and-eir-f-interface)

6.4.1.6 Interface between VLRs (G-interface) [84](#interface-between-vlrs-g-interface)

6.4.1.7 Reference point (G)MSC server - CS-MGW (Mc Reference Point) [84](#reference-point-gmsc-server---cs-mgw-mc-reference-point)

6.4.1.8 Reference Point MSC Server - GMSC Server (Nc Reference Point) [84](#reference-point-msc-server---gmsc-server-nc-reference-point)

6.4.1.9 Reference Point CS-MGW - CS-MGW (Nb Reference Point) [84](#reference-point-cs-mgw---cs-mgw-nb-reference-point)

6.4.1.10 Reference Point between the CSS and the VLR (Hv Reference Point) [84](#reference-point-between-the-css-and-the-vlr-hv-reference-point)

6.4.2 Interfaces internal to the PS domain (GPRS) [84](#interfaces-internal-to-the-ps-domain-gprs)

6.4.2.1 Interface between SGSN and HLR (Gr-interface) [84](#interface-between-sgsn-and-hlr-gr-interface)

6.4.2.2 Interface between SGSN and GGSN (Gn- and Gp-interface) [85](#interface-between-sgsn-and-ggsn-gn--and-gp-interface)

6.4.2.3 Signalling Path between GGSN and HLR (Gc-interface) [85](#signalling-path-between-ggsn-and-hlr-gc-interface)

6.4.2.4 Interface between SGSN and EIR (Gf-interface) [85](#interface-between-sgsn-and-eir-gf-interface)

6.4.2.5 Reference Point between the CSS and the Gn/Gp SGSN (Ghv Reference Point) [85](#reference-point-between-the-css-and-the-gngp-sgsn-ghv-reference-point)

6.4.3 Interfaces used by CS and PS domains [85](#interfaces-used-by-cs-and-ps-domains)

6.4.3.1 Interface between MSC/VLR and SGSN (Gs-interface) for GPRS [85](#interface-between-mscvlr-and-sgsn-gs-interface-for-gprs)

6.4.3.2 Interface between HLR/HSS and AuC (H-Interface) [85](#interface-between-hlrhss-and-auc-h-interface)

6.4.3.3 Interface between SGSN/IP-SM-GW and SMS-GMSC/SMS-IWMSC (Gd/Gdd-Interface) for GPRS [86](#interface-between-sgsnip-sm-gw-and-sms-gmscsms-iwmsc-gdgdd-interface-for-gprs)

6.4.3.4 Interface between MSC/VLR and MME (SGs-interface) for EPC [86](#interface-between-mscvlr-and-mme-sgs-interface-for-epc)

6.4.3.5 Interface between 3GPP MSC Server and MME or SGSN (Sv-interface) [86](#interface-between-3gpp-msc-server-and-mme-or-sgsn-sv-interface)

6.4.4 Interfaces internal & related to the Evolved Packet Core [86](#interfaces-internal-related-to-the-evolved-packet-core)

6.4.4.1 Interface between MME and HSS (S6a-interface) [86](#interface-between-mme-and-hss-s6a-interface)

6.4.4.2 Interface between SGSN and HSS (S6d-interface) [86](#interface-between-sgsn-and-hss-s6d-interface)

6.4.4.3 Interface between MME and S-GW (S11-interface) [86](#interface-between-mme-and-s-gw-s11-interface)

6.4.4.4 Interface between MME and MME (S10-interface) [87](#interface-between-mme-and-mme-s10-interface)

6.4.4.5 Interface between S-GW and PDN GW (S5 and S8-interface) [87](#interface-between-s-gw-and-pdn-gw-s5-and-s8-interface)

6.4.4.6 Interface between MME and EIR (S13-interface) [87](#interface-between-mme-and-eir-s13-interface)

6.4.4.7 Interface between MME and SGSN (S3-interface) [87](#interface-between-mme-and-sgsn-s3-interface)

6.4.4.8 Interface between S-GW and SGSN (S4-interface) [87](#interface-between-s-gw-and-sgsn-s4-interface)

6.4.4.9 Interface between S-GW and UTRAN (S12-interface) [87](#interface-between-s-gw-and-utran-s12-interface)

6.4.4.10 Interface between Trusted non-3GPP IP Access and S-GW/PDN GW (S2a-interface) [87](#interface-between-trusted-non-3gpp-ip-access-and-s-gwpdn-gw-s2a-interface)

6.4.4.11 Interface between PDN GW/S-GW and ePDG (S2b-interface) [87](#interface-between-pdn-gws-gw-and-epdg-s2b-interface)

6.4.4.12 Interface between PDN GW and UE (S2c-interface) [87](#interface-between-pdn-gw-and-ue-s2c-interface)

6.4.4.13 Interface between PDN GW and 3GPP AAA Server/proxy (S6b-interface) [87](#interface-between-pdn-gw-and-3gpp-aaa-serverproxy-s6b-interface)

6.4.4.14 Interface between Untrusted non-3GPP IP Access and 3GPP AAA Server/proxy (SWa-interface) [88](#interface-between-untrusted-non-3gpp-ip-access-and-3gpp-aaa-serverproxy-swa-interface)

6.4.4.15 Interface between Trusted non-3GPP IP Access and 3GPP AAA Server/proxy (STa-interface) [88](#interface-between-trusted-non-3gpp-ip-access-and-3gpp-aaa-serverproxy-sta-interface)

6.4.4.16 Interface between 3GPP AAA Server and 3GPP AAA proxy (SWd-interface) [88](#interface-between-3gpp-aaa-server-and-3gpp-aaa-proxy-swd-interface)

6.4.4.17 Interface between ePDG and 3GPP AAA Server/proxy (SWm-interface) [88](#interface-between-epdg-and-3gpp-aaa-serverproxy-swm-interface)

6.4.4.18 Interface between ePDG and Untrusted non-3GPP Access (SWn-interface) [88](#interface-between-epdg-and-untrusted-non-3gpp-access-swn-interface)

6.4.4.19 Interface between ePDG and UE (SWu-interface) [88](#interface-between-epdg-and-ue-swu-interface)

6.4.4.20 Interface between HSS and 3GPP AAA Server (SWx-interface) [88](#interface-between-hss-and-3gpp-aaa-server-swx-interface)

6.4.4.21 Interface between UE and ANDSF (S14-interface) [88](#interface-between-ue-and-andsf-s14-interface)

6.4.4.22 Reference point between HRDP AN and MME (S101-reference point) [88](#reference-point-between-hrdp-an-and-mme-s101-reference-point)

6.4.4.23 Reference point between 3GPP2 1xCS IWS and MME (S102-reference point) [89](#reference-point-between-3gpp2-1xcs-iws-and-mme-s102-reference-point)

6.4.4.24 Interface between HSGW and S-GW (S103-interface) [89](#interface-between-hsgw-and-s-gw-s103-interface)

6.4.4.25 Reference point between UE and CSG List Server (Uh reference point) [89](#reference-point-between-ue-and-csg-list-server-uh-reference-point)

6.4.4.26 Reference Point between the CSS and the S4-SGSN (S7d Reference Point) [89](#reference-point-between-the-css-and-the-s4-sgsn-s7d-reference-point)

6.4.4.27 Reference point between the CSS and the MME (S7a reference point) [89](#reference-point-between-the-css-and-the-mme-s7a-reference-point)

6.4.4.28 Reference point between the MME and the SMS-GMSC/SMS-IWMSC/SMS Router (SGd reference point) [89](#reference-point-between-the-mme-and-the-sms-gmscsms-iwmscsms-router-sgd-reference-point)

6.4.4.29 Reference point between the HSS and the SMS-GMSC/SMS-IWMSC/SMS Router (S6c reference point) [89](#reference-point-between-the-hss-and-the-sms-gmscsms-iwmscsms-router-s6c-reference-point)

6.4.4.30 Reference point between HRPD AN and MME (S121-interface) [89](#reference-point-between-hrpd-an-and-mme-s121-interface)

6a PLMN specific interfaces [90](#a-plmn-specific-interfaces)

6a.1 GCR-specific interface [90](#a.1-gcr-specific-interface)

6a.1.1 Interface between the MSC and its associated GCR (I-interface) [90](#a.1.1-interface-between-the-msc-and-its-associated-gcr-i-interface)

6a.2 (void) [90](#a.2-void-1)

6a.3 LCS-specific interfaces [90](#a.3-lcs-specific-interfaces)

6a.3.1 LCS interfaces using MAP [90](#a.3.1-lcs-interfaces-using-map)

6a.3.2 (void) [90](#a.3.2-void)

6a.3.3 (void) [90](#a.3.3-void)

6a.3.4 (void) [90](#a.3.4-void)

6a.3.5 Interface between BSC and SMLC (Lb-interface) [90](#a.3.5-interface-between-bsc-and-smlc-lb-interface)

6a.3.6 Interface between Peer SMLCs (Lp-interface) [90](#a.3.6-interface-between-peer-smlcs-lp-interface)

6a.3.7 Interface between BTS and LMU (Um-interface) [91](#a.3.7-interface-between-bts-and-lmu-um-interface)

6a.3.8 Interface between GMLC and External LCS Client (Le-interface) [91](#a.3.8-interface-between-gmlc-and-external-lcs-client-le-interface)

6a.3.9 Interface between RNS and Stand-Alone LMU, UE (Uu-interface) [91](#a.3.9-interface-between-rns-and-stand-alone-lmu-ue-uu-interface)

6a.3.10 Interface between SRNC and SAS (Stand-Alone SMLC) (Iupc-interface) [91](#a.3.10-interface-between-srnc-and-sas-stand-alone-smlc-iupc-interface)

6a.3.11 Interface between GMLC and GMLC (Lr-interface) [91](#a.3.11-interface-between-gmlc-and-gmlc-lr-interface)

6a.3.12 Interface between GMLC and MME (SLg-interface) [91](#a.3.12-interface-between-gmlc-and-mme-slg-interface)

6a.3.13 Interface between MME and E-SMLC (SLs-interface) [91](#a.3.13-interface-between-mme-and-e-smlc-sls-interface)

6a.3.14 Interface between GMLC and HSS (SLh-interface) [91](#a.3.14-interface-between-gmlc-and-hss-slh-interface)

6a.3.15 Interface between GMLC and SGSN (Lgd-interface) [91](#a.3.15-interface-between-gmlc-and-sgsn-lgd-interface)

6a.4 CAMEL-specific interfaces [92](#a.4-camel-specific-interfaces)

6a.4.1 GMSC - gsmSSF interface [92](#a.4.1-gmsc---gsmssf-interface)

6a.4.2 gsmSSF - gsmSCF interface [92](#a.4.2-gsmssf---gsmscf-interface)

6a.4.3 MSC - gsmSSF interface [92](#a.4.3-msc---gsmssf-interface)

6a.4.4 gsmSCF - HLR interface [92](#a.4.4-gsmscf---hlr-interface)

6a.4.5 gsmSCF - gsmSRF interface [92](#a.4.5-gsmscf---gsmsrf-interface)

6a.4.6 MSC - gsmSCF interface [92](#a.4.6-msc---gsmscf-interface)

6a.4.7 SGSN - gprsSSF interface [92](#a.4.7-sgsn---gprsssf-interface)

6a.4.8 gprsSSF - gsmSCF interface (Ge Reference Point) [92](#a.4.8-gprsssf---gsmscf-interface-ge-reference-point)

6a.5 CBS-specific interfaces [92](#a.5-cbs-specific-interfaces)

6a.5.1 Interface between the CBC and RNS (Iu_BC Interface) [92](#a.5.1-interface-between-the-cbc-and-rns-iu_bc-interface)

6a.5.2 Interface between the CBC and MME (SBc Interface) [93](#a.5.2-interface-between-the-cbc-and-mme-sbc-interface)

6a.5.3 Interface between the CBC and BSC [93](#a.5.3-interface-between-the-cbc-and-bsc)

6a.6 Number portability specific interfaces [93](#a.6-number-portability-specific-interfaces)

6a.6.1 IN-based solution [93](#a.6.1-in-based-solution)

6a.6.1.1 NPDB to MSC interface [93](#a.6.1.1-npdb-to-msc-interface)

6a.6.2 Signalling Relay-based solution [93](#a.6.2-signalling-relay-based-solution)

6a.6.2.1 GMSC to MNP-SRF interface [93](#a.6.2.1-gmsc-to-mnp-srf-interface)

6a.6.2.2 MNP-SRF to HLR interface [93](#a.6.2.2-mnp-srf-to-hlr-interface)

6a.7 IM Subsystem Reference Points [93](#a.7-im-subsystem-reference-points)

6a.7.1 Reference Point HSS - CSCF (Cx Reference Point) [93](#a.7.1-reference-point-hss---cscf-cx-reference-point)

6a.7.2 Reference Point CSCF - UE (Gm Reference Point) [94](#a.7.2-reference-point-cscf---ue-gm-reference-point)

6a.7.3 Reference Point MGCF - IMS-MGW (Mn Reference Point) [94](#a.7.3-reference-point-mgcf---ims-mgw-mn-reference-point)

6a.7.4 Reference Point MGCF - CSCF (Mg Reference Point) [94](#a.7.4-reference-point-mgcf---cscf-mg-reference-point)

6a.7.5 (void) [94](#a.7.5-void-1)

6a.7.5a Reference Point AS-MRFC for media control (Cr Reference Point) [94](#a.7.5a-reference-point-as-mrfc-for-media-control-cr-reference-point)

6a.7.5b Reference Point AS-MRFC for session control (Mr′ Reference Point) [94](#a.7.5b-reference-point-as-mrfc-for-session-control-mr-reference-point)

6a.7.6 Reference Point CSCF - MRFC (Mr Reference Point) [95](#a.7.6-reference-point-cscf---mrfc-mr-reference-point)

6a.7.6a Reference Point MRFC - MRFP (Mp Reference Point) [95](#a.7.6a-reference-point-mrfc---mrfp-mp-reference-point)

6a.7.7 Reference Point CSCF - CSCF (Mw Reference Point) [95](#a.7.7-reference-point-cscf---cscf-mw-reference-point)

6a.7.8 (void) [95](#a.7.8-void)

6a.7.8a Reference Point CSCF - MRB (ISC Reference Point) [95](#a.7.8a-reference-point-cscf---mrb-isc-reference-point)

6a.7.9 (void) [95](#a.7.9-void)

6a.7.9a Reference Point AS - MRB (Rc Reference Point) [95](#a.7.9a-reference-point-as---mrb-rc-reference-point)

6a.7.10 Reference Point CSCF - BGCF (Mi reference point) [95](#a.7.10-reference-point-cscf---bgcf-mi-reference-point)

6a.7.11 Reference Point BGCF - MGCF (Mj reference point) [95](#a.7.11-reference-point-bgcf---mgcf-mj-reference-point)

6a.7.12 Reference Point BGCF/IBCF - BGCF (Mk reference point) [96](#a.7.12-reference-point-bgcfibcf---bgcf-mk-reference-point)

6a.7.13 Reference Point CSCF- SLF (Dx Reference Point) [96](#a.7.13-reference-point-cscf--slf-dx-reference-point)

6a.7.14 Reference Point to IMS media plane (Mb reference point) [96](#a.7.14-reference-point-to-ims-media-plane-mb-reference-point)

6a.7.15 Reference Point S‑CSCF - AS (ISC Reference Point) [96](#a.7.15-reference-point-scscf---as-isc-reference-point)

6a.7.15a Reference Point E-CSCF - EATF (I4 Reference Point) [96](#a.7.15a-reference-point-e-cscf---eatf-i4-reference-point)

6a.7.15b Reference Point I-CSCF - EATF (I5 Reference Point) [96](#a.7.15b-reference-point-i-cscf---eatf-i5-reference-point)

6a.7.16 Reference Point HSS - SIP AS or OSA SCS (Sh Reference Point) [96](#a.7.16-reference-point-hss---sip-as-or-osa-scs-sh-reference-point)

6a.7.17 Reference Point HSS - CAMEL IM-SSF (Si Reference Point) [96](#a.7.17-reference-point-hss---camel-im-ssf-si-reference-point)

6a.7.18 Reference Point UE - AS (Ut Reference Point) [96](#a.7.18-reference-point-ue---as-ut-reference-point)

6a.7.19 Reference Point AS- SLF (Dh Reference Point) [97](#a.7.19-reference-point-as--slf-dh-reference-point)

6a.7.20 Reference Point CSCF/BGCF - IBCF (Mx Reference Point) [97](#a.7.20-reference-point-cscfbgcf---ibcf-mx-reference-point)

6a.7.21 Reference Point IBCF - TrGW (Ix Reference Point) [97](#a.7.21-reference-point-ibcf---trgw-ix-reference-point)

6a.7.22 Reference Point I‑CSCF - AS (Ma Reference Point) [97](#a.7.22-reference-point-icscf---as-ma-reference-point)

6a.7.23 Reference Point P‑CSCF - IMS Access Gateway (Iq Reference Point) [97](#a.7.23-reference-point-pcscf---ims-access-gateway-iq-reference-point)

6a.7.23a Reference Point E‑CSCF - LRF (Ml Reference Point) [97](#a.7.23a-reference-point-ecscf---lrf-ml-reference-point)

6a.7.24 Reference Point IBCF - IBCF (Ici Reference Point) [97](#a.7.24-reference-point-ibcf---ibcf-ici-reference-point)

6a.7.25 Reference Point TrGW - TrGW (Izi Reference Point) [97](#a.7.25-reference-point-trgw---trgw-izi-reference-point)

6a.7.26 Void [98](#a.7.26-void)

6a.7.27 Reference Point MSC Server - CSCF (I2 Reference Point) [98](#a.7.27-reference-point-msc-server---cscf-i2-reference-point)

6a.7.28 Reference Point MSC Server - TAS (I3 Reference Point) [98](#a.7.28-reference-point-msc-server---tas-i3-reference-point)

6a.7.29 Reference Point ICS UE - SCC AS (I1 Reference Point) [98](#a.7.29-reference-point-ics-ue---scc-as-i1-reference-point)

6a.7.30 Reference Point IBCF - Application Server (AS) (Ms Reference Point) [98](#a.7.30-reference-point-ibcf---application-server-as-ms-reference-point)

6a.8 Void [98](#a.8-void)

6a.9 Reference Points for 3GPP/WLAN Interworking [98](#a.9-reference-points-for-3gppwlan-interworking)

6a.9.1 Reference point 3GPP AAA Server - HLR (D'/Gr' Reference Point) [98](#a.9.1-reference-point-3gpp-aaa-server---hlr-dgr-reference-point)

6a.9.2 Reference point WLAN access network - 3GPP AAA Proxy/Server (Wa Reference Point) [99](#a.9.2-reference-point-wlan-access-network---3gpp-aaa-proxyserver-wa-reference-point)

6a.9.3 Reference point 3GPP AAA Server - 3GPP AAA Proxy (Wd Reference Point) [99](#a.9.3-reference-point-3gpp-aaa-server---3gpp-aaa-proxy-wd-reference-point)

6a.9.4 Reference point 3GPP AAA Server/Proxy - WAG (Wg Reference Point) [99](#a.9.4-reference-point-3gpp-aaa-serverproxy---wag-wg-reference-point)

6a.9.5 Reference point PDG - packet data networks (Wi Reference Point) [99](#a.9.5-reference-point-pdg---packet-data-networks-wi-reference-point)

6a.9.6 Reference Point 3GPP AAA Server/Proxy - PDG (Wm Reference Point) [99](#a.9.6-reference-point-3gpp-aaa-serverproxy---pdg-wm-reference-point)

6a.9.7 Reference Point WAG - WLAN access network (Wn Reference Point) [99](#a.9.7-reference-point-wag---wlan-access-network-wn-reference-point)

6a.9.8 Reference Point WAG - PDG (Wp Reference Point) [99](#a.9.8-reference-point-wag---pdg-wp-reference-point)

6a.9.9 Reference point WLAN UE - PDG (Wu Reference Point) [99](#a.9.9-reference-point-wlan-ue---pdg-wu-reference-point)

6a.9.10 Reference point WLAN UE - WLAN access network (Ww Reference Point) [100](#a.9.10-reference-point-wlan-ue---wlan-access-network-ww-reference-point)

6a.9.11 Reference point 3GPP AAA Server - HSS (Wx Reference Point) [100](#a.9.11-reference-point-3gpp-aaa-server---hss-wx-reference-point)

6a.9.12 Reference point 3GPP AAA Server - SLF (Dw reference point) [100](#a.9.12-reference-point-3gpp-aaa-server---slf-dw-reference-point)

6a.10 MBMS specific reference points for GPRS [100](#a.10-mbms-specific-reference-points-for-gprs)

6a.10.1 Reference point GGSN - BM-SC (Gmb Reference Point) [100](#a.10.1-reference-point-ggsn---bm-sc-gmb-reference-point)

6a.10.2 Reference point BM-SC - BM-SC (Mz Reference Point) [100](#a.10.2-reference-point-bm-sc---bm-sc-mz-reference-point)

6a.10.3 Reference point GGSN - RNS (or BSS Iu mode) (Gmc Reference Point) [100](#a.10.3-reference-point-ggsn---rns-or-bss-iu-mode-gmc-reference-point)

6a.11 MBMS specific reference points for EPS [101](#a.11-mbms-specific-reference-points-for-eps)

6a.11.1 Reference point MBMS‑GW - BM-SC (SGmb Reference Point) [101](#a.11.1-reference-point-mbmsgw---bm-sc-sgmb-reference-point)

6a.11.2 Reference point MBMS‑GW - BM-SC (SGi-mb Reference Point) [101](#a.11.2-reference-point-mbmsgw---bm-sc-sgi-mb-reference-point)

6a.11.3 Reference point MBMS‑GW - MME (Sm Reference Point) [101](#a.11.3-reference-point-mbmsgw---mme-sm-reference-point)

6a.11.4 Reference point MBMS‑GW - SGSN (Sn Reference Point) [101](#a.11.4-reference-point-mbmsgw---sgsn-sn-reference-point)

6a.11.5 Reference point MBMS‑GW - E-UTRAN/UTRAN (M1 Reference Point) [101](#a.11.5-reference-point-mbmsgw---e-utranutran-m1-reference-point)

6a.11.6 Reference point MME - MCE (M3 Reference Point) [101](#a.11.6-reference-point-mme---mce-m3-reference-point)

6a.11.7 Reference point MCE - eNodeB (M2 Reference Point) [101](#a.11.7-reference-point-mce---enodeb-m2-reference-point)

6a.11.8 Reference point Content Provider/SCEF - BM-SC (xMB Reference Point) [101](#a.11.8-reference-point-content-providerscef---bm-sc-xmb-reference-point)

6a.12 Reference Points for 3GPP Generic User Profile (GUP) [101](#a.12-reference-points-for-3gpp-generic-user-profile-gup)

6a.12.1 Reference Point GUP Server - Applications (Rg Reference Point) [101](#a.12.1-reference-point-gup-server---applications-rg-reference-point)

6a.12.2 Reference Point GUP Server - HSS and Applications - HSS (Rp Reference Point) [102](#a.12.2-reference-point-gup-server---hss-and-applications---hss-rp-reference-point)

6a.13 Reference Points for Policy and Charging Control [102](#a.13-reference-points-for-policy-and-charging-control)

6a.13.1 Reference Point PCEF - PCRF/H-PCRF/V-PCRF (Gx Reference Point) [102](#a.13.1-reference-point-pcef---pcrfh-pcrfv-pcrf-gx-reference-point)

6a.13.2 Reference Point PCRF - Application Function (Rx Reference Point) [102](#a.13.2-reference-point-pcrf---application-function-rx-reference-point)

6a.13.3 Reference Point SPR - PCRF (Sp Reference Point) [102](#a.13.3-reference-point-spr---pcrf-sp-reference-point)

6a.13.4 Reference Point OCS - PCEF (Gy Reference Point) [102](#a.13.4-reference-point-ocs---pcef-gy-reference-point)

6a.13.5 Reference Point OFCS - PCEF (Gz Reference Point) [102](#a.13.5-reference-point-ofcs---pcef-gz-reference-point)

6a.13.6 Reference Point Trusted non-3GPP IP Access and PCRF/VPCRF (Gxa Reference Point) [102](#a.13.6-reference-point-trusted-non-3gpp-ip-access-and-pcrfvpcrf-gxa-reference-point)

6a.13.7 Reference Point ePDG and PCRF/VPCRF (Gxb Reference Point) [102](#a.13.7-reference-point-epdg-and-pcrfvpcrf-gxb-reference-point)

6a.13.7a Reference Point ePDG and PCRF/VPCRF (Gxb\* Reference Point) [103](#a.13.7a-reference-point-epdg-and-pcrfvpcrf-gxb-reference-point)

6a.13.8 Reference point between S-GW and PCRF/VPCRF (Gxc-interface) [103](#a.13.8-reference-point-between-s-gw-and-pcrfvpcrf-gxc-interface)

6a.13.9 Reference Point PCRF/VPCRF - BBERF (Gxx Reference Point) [103](#a.13.9-reference-point-pcrfvpcrf---bberf-gxx-reference-point)

6a.13.10 Reference Point HPCRF - VPCRF (S9- interface) [103](#a.13.10-reference-point-hpcrf---vpcrf-s9--interface)

6a.13.11 Reference Point UDR - PCRF (Ud Reference Point) [103](#a.13.11-reference-point-udr---pcrf-ud-reference-point)

6a.13.12 Reference Point TDF - PCRF/H-PCRF/V-PCRF (Sd Reference Point) [103](#a.13.12-reference-point-tdf---pcrfh-pcrfv-pcrf-sd-reference-point)

6a.13.13 Reference Point OCS - PCRF/H-PCRF (Sy Reference Point) [103](#a.13.13-reference-point-ocs---pcrfh-pcrf-sy-reference-point)

6a.13.14 Reference Point HNB GW - PCRF/V-PCRF (S15 Reference Point) [103](#a.13.14-reference-point-hnb-gw---pcrfv-pcrf-s15-reference-point)

6a.13.15 Reference Point BPCF - PCRF/v-PCRF (S9a Reference Point) [103](#a.13.15-reference-point-bpcf---pcrfv-pcrf-s9a-reference-point)

6a.13.16 Reference Point OCS - TDF (Gyn Reference Point) [104](#a.13.16-reference-point-ocs---tdf-gyn-reference-point)

6a.13.17 Reference Point OFCS - TDF (Gzn Reference Point) [104](#a.13.17-reference-point-ofcs---tdf-gzn-reference-point)

6a.13.18 Void [104](#a.13.18-void)

6a.13.19 Reference Point TSSF - PCRF/H-PCRF (St Reference Point) [104](#a.13.19-reference-point-tssf---pcrfh-pcrf-st-reference-point)

6a.13.20 Reference point between PFDF and PCEF (Gw reference point) [104](#a.13.20-reference-point-between-pfdf-and-pcef-gw-reference-point)

6a.13.21 Reference point between PFDF and TDF (Gwn reference point) [104](#a.13.21-reference-point-between-pfdf-and-tdf-gwn-reference-point)

6a.14 SMSIP specific reference points [104](#a.14-smsip-specific-reference-points)

6a.14.1 Reference point IP-SM-GW - HSS (J Reference Point) [104](#a.14.1-reference-point-ip-sm-gw---hss-j-reference-point)

6a.15 User Data Convergence specific reference points [104](#a.15-user-data-convergence-specific-reference-points)

6a.15.1 Reference point Application Front Ends - UDR (Ud Reference Point) [104](#a.15.1-reference-point-application-front-ends---udr-ud-reference-point)

6a.16 Specific reference points for facilitating communications with packet data networks and applications [104](#a.16-specific-reference-points-for-facilitating-communications-with-packet-data-networks-and-applications)

6a.16.1 Reference point MTC-IWF - SCS (Tsp reference point) [104](#a.16.1-reference-point-mtc-iwf---scs-tsp-reference-point)

6a.16.2 Reference point MTC-IWF - HSS/HLR (S6m reference point) [105](#a.16.2-reference-point-mtc-iwf---hsshlr-s6m-reference-point)

6a.16.3 Reference point MTC-AAA - HSS/HLR (S6n reference point) [105](#a.16.3-reference-point-mtc-aaa---hsshlr-s6n-reference-point)

6a.16.4 Reference point MTC-IWF - SMS-SC (T4 reference point) [105](#a.16.4-reference-point-mtc-iwf---sms-sc-t4-reference-point)

6a.16.5 Reference point between the HSS and the SCEF (S6t reference point) [105](#a.16.5-reference-point-between-the-hss-and-the-scef-s6t-reference-point)

6a.16.6 Reference point between the MME and the SCEF (T6a reference point) [105](#a.16.6-reference-point-between-the-mme-and-the-scef-t6a-reference-point)

6a.16.7 Reference point between the SGSN and the SCEF (T6b reference point) [105](#a.16.7-reference-point-between-the-sgsn-and-the-scef-t6b-reference-point)

6a.16.8 Reference point between the RCAF and the SCEF (Ns reference point) [105](#a.16.8-reference-point-between-the-rcaf-and-the-scef-ns-reference-point)

6a.16.9 Reference point between the PCRF and the SCEF (Nt reference point) [106](#a.16.9-reference-point-between-the-pcrf-and-the-scef-nt-reference-point)

6a.16.10 Reference point between the PFDF and the SCEF (Nu reference point) [106](#a.16.10-reference-point-between-the-pfdf-and-the-scef-nu-reference-point)

6a.17 GCSE_LTE specific reference points [106](#a.17-gcse_lte-specific-reference-points)

6a.17.1 Reference point GCS AS - BM-SC (MB2 Reference Point) [106](#a.17.1-reference-point-gcs-as---bm-sc-mb2-reference-point)

6a.17.2 Reference point GCS AS - UE (GC1 Reference Point) [106](#a.17.2-reference-point-gcs-as---ue-gc1-reference-point)

6a.18 ProSe specific reference points [106](#a.18-prose-specific-reference-points)

6a.18.1 Reference point UE - ProSe Application Server (PC1 Reference Point) [106](#a.18.1-reference-point-ue---prose-application-server-pc1-reference-point)

6a.18.2 Reference point ProSe Function - ProSe Application Server (PC2 Reference Point) [106](#a.18.2-reference-point-prose-function---prose-application-server-pc2-reference-point)

6a.18.3 Reference point UE - ProSe Function (PC3 Reference Point) [106](#a.18.3-reference-point-ue---prose-function-pc3-reference-point)

6a.18.4 Reference point HSS - ProSe Function (PC4a Reference Point) [107](#a.18.4-reference-point-hss---prose-function-pc4a-reference-point)

6a.18.5 Reference point SLP - ProSe Function (PC4b Reference Point) [107](#a.18.5-reference-point-slp---prose-function-pc4b-reference-point)

6a.18.6 Reference point UE - UE (PC5 Reference Point) [107](#a.18.6-reference-point-ue---ue-pc5-reference-point)

6a.18.7 Reference point ProSe Function - ProSe Function in different PLMNs (PC6 Reference Point) [107](#a.18.7-reference-point-prose-function---prose-function-in-different-plmns-pc6-reference-point)

6a.18.8 Reference point ProSe Function in HPLMN - ProSe Function in VPLMN (PC7 Reference Point) [107](#a.18.8-reference-point-prose-function-in-hplmn---prose-function-in-vplmn-pc7-reference-point)

6a.19 Reference points for RAN user plane congestion detection and reporting [107](#a.19-reference-points-for-ran-user-plane-congestion-detection-and-reporting)

6a.19.1 Reference Point RCAF - PCRF/ V-PCRF (Np Reference Point) [107](#a.19.1-reference-point-rcaf---pcrf-v-pcrf-np-reference-point)

6a.19.2 Reference point between MME and RCAF (Nq reference point) [107](#a.19.2-reference-point-between-mme-and-rcaf-nq-reference-point)

6a.19.3 Reference point between SGSN and RCAF (Nq' reference point) [107](#a.19.3-reference-point-between-sgsn-and-rcaf-nq-reference-point)

7 Reference points between the PLMN and other networks [108](#reference-points-between-the-plmn-and-other-networks)

7.1 Reference point fixed networks - MSC [108](#reference-point-fixed-networks---msc)

7.2 Reference point GGSN - packet data networks (Gi reference point) [108](#reference-point-ggsn---packet-data-networks-gi-reference-point)

7.2a Reference point PDN GW - packet data networks (SGi reference point) [108](#a-reference-point-pdn-gw---packet-data-networks-sgi-reference-point)

7.3 Reference point GMLC - external LCS Client (Le reference point) [108](#reference-point-gmlc---external-lcs-client-le-reference-point)

7.4 Reference Point CSCF/IBCF - Multimedia IP networks (Mm Reference Point) [108](#reference-point-cscfibcf---multimedia-ip-networks-mm-reference-point)

7.5 (void) [108](#void-2)

7.6 Reference point PDG - packet data networks (Wi reference point) [108](#reference-point-pdg---packet-data-networks-wi-reference-point)

7.7 Reference Point WAG - WLAN access network (Wn reference point) [109](#reference-point-wag---wlan-access-network-wn-reference-point)

7.8 Reference point MTC-IWF - SCS (Tsp reference point) [109](#reference-point-mtc-iwf---scs-tsp-reference-point)

Annex A (informative): Description for GLR-related entities and interfaces [110](#annex-a-informative-description-for-glr-related-entities-and-interfaces)

A.1 Normative references [110](#a.1-normative-references)

A.2 Definitions related to Gateway Location Register (GLR) [110](#a.2-definitions-related-to-gateway-location-register-glr)

A.2.1 Gateway Location Register (GLR) [110](#a.2.1-gateway-location-register-glr)

A.2.2 Intermediate Mobile-services Switching Centre (IM-MSC) [110](#a.2.2-intermediate-mobile-services-switching-centre-im-msc)

A.2.3 Intermediate GPRS Serving Node (IM-GSN) [110](#a.2.3-intermediate-gprs-serving-node-im-gsn)

A.3 The entities of the mobile system [110](#a.3-the-entities-of-the-mobile-system)

A.3.1 Gateway Location Register (GLR) [110](#a.3.1-gateway-location-register-glr)

A.3.2 Intermediate Mobile-services Switching Centre (IM-MSC) [111](#a.3.2-intermediate-mobile-services-switching-centre-im-msc)

A.3.3 Intermediate GPRS Serving Node (IM-GSN) [111](#a.3.3-intermediate-gprs-serving-node-im-gsn)

A.4 Configuration of a Public Land Mobile Network [111](#a.4-configuration-of-a-public-land-mobile-network)

A.4.1 Basic configuration with GLR introduction [111](#a.4.1-basic-configuration-with-glr-introduction)

A.5 PLMN interfaces [112](#a.5-plmn-interfaces)

A.5.1 Interface between the HLR and the GLR (GLa-interface) [112](#a.5.1-interface-between-the-hlr-and-the-glr-gla-interface)

A.5.2 Interface between the VLR and the GLR (GLb-interface) [112](#a.5.2-interface-between-the-vlr-and-the-glr-glb-interface)

A.5.3 Interface between the SGSN and the GLR (GLc-interface) [112](#a.5.3-interface-between-the-sgsn-and-the-glr-glc-interface)

A.5.4 Interface between the GLR and the IM_MSC (GLd‑interface) [112](#a.5.4-interface-between-the-glr-and-the-im_msc-gldinterface)

A.5.5 Interface between the GLR and the IM_GSN (GLe‑interface) [112](#a.5.5-interface-between-the-glr-and-the-im_gsn-gleinterface)

A.5.6 Interface between the SMS-GMSC and the GLR (GLf‑interface) [113](#a.5.6-interface-between-the-sms-gmsc-and-the-glr-glfinterface)

A.5.7 Interface between the SMS-GMSC and the IM_MSC (GLg‑interface) [113](#a.5.7-interface-between-the-sms-gmsc-and-the-im_msc-glginterface)

A.5.8 Interface between the MSC and the IM_MSC (GLh‑interface) [113](#a.5.8-interface-between-the-msc-and-the-im_msc-glhinterface)

A.5.9 Interface between the GMLC and the IM_MSC (GLi‑interface) [113](#a.5.9-interface-between-the-gmlc-and-the-im_msc-gliinterface)

A.5.10 Interface between the GGSN and the IM_GSN (GLj‑interface) [113](#a.5.10-interface-between-the-ggsn-and-the-im_gsn-gljinterface)

A.5.11 Interface between the SGSN and the IM_GSN (GLk‑interface) [113](#a.5.11-interface-between-the-sgsn-and-the-im_gsn-glkinterface)

Annex B (informative): Change history [114](#annex-b-informative-change-history)
...
\[139\] 3GPP TS 26.233: "Transparent end-to-end Packet-switched Streaming Service (PSS); General Description".
...
\[142\] 3GPP TS 23.179: "Functional architecture and information flows to support mission critical communication services; Stage 2".

\[143\] 3GPP TS 26.114: "IP Multimedia Subsystem (IMS); Multimedia telephony; Media handling and interaction".

\[144\] 3GPP TS 26.141: "IP Multimedia System (IMS) Messaging and Presence; Media formats and codecs".

\[145\] 3GPP TS 23.214: "Architecture enhancements for control and user plane separation of EPC nodes; Stage 2".
...
To provide the mobile service as it is defined, it is necessary to introduce some specific functions. These functional entities can be implemented in different equipment or gathered. In any case, exchanges of data occur between these entities.
...
Based on this information, the HSS also is responsible to support the call control and session management entities of the different Domains and Subsystems (defined in clauses 3.3 and 3.3a) of the operator as shown in figure 0-a.
...
The equipment is classified as "allowed", "tracked", "prohibited" or it may be unknown as specified in TS 22.016 \[2\] and TS 29.002 \[26\].

This functional entity contains one or several databases which store(s) the IMEIs used in the system.

The mobile equipment may be classified as "allowed", "tracked" and "prohibited" and therefore may be stored in three separate lists.

An IMEI may also be unknown to the EIR.

An EIR shall as a minimum contain an "allowed list" (Equipment classified as "allowed").
...
The Serving GW can be split into SGW-C and SGW-U, which jointly provide above functionalities. The functional split between SGW-C and SGW-U are defined in TS 23.214 \[145\].
...
The PDN GW can be split into PGW-C and PGW-U, which jointly provide above functionalities. The functional split between PGW-C and PGW-U are defined in TS 23.214 \[145\].

##### 4.1.4.2.3 Local GW (L-GW)

A Local GW is a gateway towards the IP networks (e.g. residential/enterprise networks, Internet).
...
The split of functions between eNodeB and EPC is described in the specifications TS 23.401 \[76\], TS 36.300 \[78\] and TS 36.401 \[79\].
...
**eNodeB:** The eNodeB is a network element of E-UTRAN that may provide measurement results for position estimation and makes measurements of radio signals for a target UE and communicates these measurements to an E-SMLC.
...
A Local GW is a gateway towards the IP networks (e.g. residential/enterprise networks, Internet) associated with the Home NodeB, more details can be found in TS 23.060 \[9a\]. The Local GW can be colocated with the Home NodeB or can be a standalone GW (with Serving GW and Local GW collocated) residing in the Local Network.
...
A Local GW is a gateway towards the IP networks (e.g. residential/enterprise networks, Internet) associated with the Home eNodeB, more details can be found in TS 23.401 \[76\]. The Local GW can be collocated with the Home eNodeB or can be a standalone GW (with Serving GW and Local GW collocated) residing in the Local Network.
...
The TDF can be split into TDF-C and TDF-U, which jointly provide TDF functionalities. The functional split between TDF-C and TDF-U are defined in TS 23.214 \[145\].
...
When TCP is being used, TCP connection is between a TCP client and a TCP server as defined in RFC793 \[138\]. A TCP Proxy Function splits a TCP connection such that it terminates the TCP connection received from the UE and establishes a corresponding TCP connection to the other end system in packet data network.

Note: The TCP Proxy Function can be deployed in a GGSN/PGW or as an external function beyond SGi/Gi. The TCP Proxy is deployed such that it is transparent to the UE and its mobility.
...
PSS Server provides the 3GPP packet switched streaming service based on the IETF RTSP/SDP and/or HTTP standards, with 3GPP extensions.

The description of the PSS Server is detailed in TS 26.233 \[139\].

## 4a.32 Specific entities for Group Communication System Enablers for LTE (GCSE_LTE)

### 4a.32.1 Group Communication Service Application Server (GCS AS)

The GCS AS transfers application data, e.g. media data and/or application signalling, to a group of UEs either over MBMS Bearer Services using the Broadcast Mode of MBMS (TS 23.246 \[70\]); or over EPS Bearers (TS 23.401 \[76\]); or over both MBMS and EPS bearer services. GCS AS uses the MB2 reference point to deliver data to UEs over MBMS Bearer Services.
...
MCPTT AS transfers mission critical application data, e.g. media data and/or application signalling, to a group of UEs over on-network services. MCPTT is provided either via on-network services and/or off-network services as specified in TS 23.179 \[142\].

The description of the MCPTT AS with the network functional models and the reference points is detailed in TS 23.179 \[142\].

## 4a.37 Packet Flow Description Function (PFDF)

The Packet Flow Description Function (PFDF) is a repository which stores Packet Flow Descriptions (PFDs) that can be managed, i.e. added, updated, or removed, by the SCS/AS (3rd party service provider) via the SCEF. The functional description of the PFDF can be found in TS 23.682 \[132\].

## 4a.38 5G System architecture

The Stage 2 system architecture for the 5G System is specified in TS 23.501 \[147\].
...
The configuration of the PSS entities for GPRS and EPS is represented in figures 5.19-1 and 5.19-2 respectively. PSS for GPRS supports UTRAN and GERAN. PSS for EPS supports E-UTRAN, UTRAN and GERAN. Further details of the PSS Service are described in TS 26.233 \[139\].
...
The reference architecture model, the reference points and the functional entities to facilitate ProSe are described in TS 23.303 \[141\].

## 5.21 Configuration for RAN user plane congestion detection and reporting

RAN user plane congestion detection and reporting enables the PCRF to take the RAN user plane congestion status into account for policy decisions. This functionality is applicable only in case of UTRAN/E-UTRAN accesses. The configuration of the related entities is depicted in Figure 5.21.
...
In the network with the GLR when receiving a PDP PDU from the external network the GGSN sends a notification to the IM_GSN by the routing information from the HLR (see TS 29.060 \[51\]). The GGSN regards the IM_GSN as the SGSN via this interface.

## A.5.11 Interface between the SGSN and the IM_GSN (GLk‑interface)

In the network with the GLR when receiving a PDP notification from the GGSN, the IM_GSN relays the notification to the SGSN by the routing information from the GLR (see TS 29.060 \[51\]). The SGSN regards the IM_GSN as the GGSN via this interface.
...
| 2021-03 | SP-91E | SP-210063 | 0018 | 1 | C | GAD shape for location estimate in Local Coordinates | **17.0.0** |
| 2024-03 | \- | \- | \- | \- | \- | Update to Rel-18 version (MCC) | **18.0.0** |
| 2025-09 | \- | \- | \- | \- | \- | Update to Rel-19 version (MCC) | **19.0.0** |
