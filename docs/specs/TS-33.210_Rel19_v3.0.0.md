> **TS-33.210_Rel19_v3.0.0** — converted from official 3GPP archive.
> Source: https://www.3gpp.org/ftp/Specs/archive/33_series/33.210/33210-j30.zip
> Downloaded: 2026-08-23 · DOCX→GFM via pandoc.

3GPP TS 33.210 V19.3.0 (2026-01)

Technical Specification

3rd Generation Partnership Project;

Technical Specification Group Services and System Aspects;Network Domain Security (NDS);  
...
> Keywords
>
> UMTS, Security, IP, Network, Management
>
> ***3GPP***
>
> Postal address
...
4 Overview over network domain security for IP based protocols [10](#overview-over-network-domain-security-for-ip-based-protocols)

4.1 Introduction [10](#introduction-1)

4.2 Protection at the network layer [10](#protection-at-the-network-layer)

4.3 Security for native IP based protocols [10](#security-for-native-ip-based-protocols)

4.4 Security domains [10](#security-domains)

4.4.1 Security domains and interfaces [10](#security-domains-and-interfaces)

4.5 Security Gateways (SEGs) [11](#security-gateways-segs)

5 Key management and distribution architecture for NDS/IP [11](#key-management-and-distribution-architecture-for-ndsip)

5.1 Security services afforded to the protocols [11](#security-services-afforded-to-the-protocols)

5.2 Security Associations (SAs) [11](#security-associations-sas)

5.2.0 General [11](#general)

5.2.1 Security Policy Database (SPD) [12](#security-policy-database-spd)

5.2.2 Security Association Database (SAD) [12](#security-association-database-sad)

5.3 Profiling of IPsec [12](#profiling-of-ipsec)

5.3.0 General [12](#general-1)

5.3.1 Support of ESP [12](#support-of-esp)

5.3.2 Support of tunnel mode [13](#support-of-tunnel-mode)

5.3.3 Support of ESP encryption transforms [13](#support-of-esp-encryption-transforms)

5.3.4 Support of ESP authentication transforms [13](#support-of-esp-authentication-transforms)

5.3.5 Requirements on the construction of the IV [13](#requirements-on-the-construction-of-the-iv)

5.4 Profiling of IKEv2 [13](#profiling-of-ikev2)

5.4.0 General [13](#general-2)

5.4.1 Void [14](#void)

5.4.2 Profiling of IKEv2 [14](#profiling-of-ikev2-1)

5.4.3 Void [15](#void-1)

5.5 Security policy granularity [15](#security-policy-granularity)

5.6 Network domain security key management and distribution architecture for native IP based protocols [15](#network-domain-security-key-management-and-distribution-architecture-for-native-ip-based-protocols)

5.6.1 Network domain security architecture outline [15](#network-domain-security-architecture-outline)

5.6.2 Interface description [16](#interface-description)

6 Other 3GPP profiles [17](#other-3gpp-profiles)

6.1 General [17](#general-3)

6.2 TLS protocol profiles [17](#tls-protocol-profiles)

6.2.1 General [17](#general-4)

6.2.2 Profiling for TLS 1.3 [18](#profiling-for-tls-1.3)

6.2.3 Profiling for TLS 1.2 [18](#profiling-for-tls-1.2)

6.3 JWE and JWS profiles [20](#jwe-and-jws-profiles)

6.3.1 General [20](#general-5)

6.3.2 JWE profile [20](#jwe-profile)

6.3.2.1 General [20](#general-6)

6.3.2.2 N32 interface [20](#n32-interface)

6.3.3 JWS profile [20](#jws-profile)

6.3.3.1 General [20](#general-7)

6.3.3.2 N32 interface [20](#n32-interface-1)

6.3.3.3 Client credentials assertion [21](#client-credentials-assertion)

6.3.3.4 Access token [21](#access-token)

7 Void [21](#void-2)

Annex A (informative): Other issues [22](#annex-a-informative-other-issues)

A.1 Network Address Translators (NATs) and Transition Gateways (TrGWs) [22](#a.1-network-address-translators-nats-and-transition-gateways-trgws)

A.2 Filtering routers and firewalls [22](#a.2-filtering-routers-and-firewalls)

A.3 The relationship between BGs and SEGs [22](#a.3-the-relationship-between-bgs-and-segs)

Annex B (normative): Security protection for GTP [23](#annex-b-normative-security-protection-for-gtp)

B.0 General [23](#b.0-general)

B.1 The need for security protection [23](#b.1-the-need-for-security-protection)

B.2 Policy discrimination of GTP-C and GTP-U [23](#b.2-policy-discrimination-of-gtp-c-and-gtp-u)

B.3 Protection of GTP-C transport protocols and interfaces [24](#b.3-protection-of-gtp-c-transport-protocols-and-interfaces)

Annex C (normative): Security protection of IMS protocols [25](#annex-c-normative-security-protection-of-ims-protocols)

C.0 General [25](#c.0-general)

C.1 The need for security protection [25](#c.1-the-need-for-security-protection)

C.2 Protection of IMS protocols and interfaces [25](#c.2-protection-of-ims-protocols-and-interfaces)

Annex D (normative): Security protection of UTRAN/GERAN IP transport protocols [26](#annex-d-normative-security-protection-of-utrangeran-ip-transport-protocols)

D.0 General [26](#d.0-general)

D.1 The need for security protection [26](#d.1-the-need-for-security-protection)

D.2 Protection of UTRAN/GERAN IP transport protocols and interfaces [26](#d.2-protection-of-utrangeran-ip-transport-protocols-and-interfaces)

Annex E (informative): Void [27](#annex-e-informative-void)

Annex F (informative): Change history [28](#annex-f-informative-change-history)
...
\[51\] IETF RFC 8442: "ECDHE_PSK with AES-GCM and AES-CCM Cipher Suites for TLS 1.2 and DTLS 1.2”.
...
\[70\] IETF RFC 8221: "Cryptographic Algorithm Implementation Requirements and Usage Guidance for Encapsulating Security Payload (ESP) and Authentication Header (AH)".

\[71\] IETF RFC 8422: "Elliptic Curve Cryptography (ECC) Cipher Suites for Transport Layer Security (TLS) ".

\[72\] IETF RFC 8937: " Randomness Improvements for Security Protocols".

\[73\] IETF RFC-8247: "Algorithm Implementation Requirements and Usage Guidance for the Internet Key Exchange Protocol Version 2 (IKEv2)".

\[74\] RFC 9110: "HTTP Semantics".

\[75\] IETF RFC 9147: "Datagram Transport Layer Security Version 1.3".

\[76\] IETF RFC 8750: "Implicit Initialization Vector (IV) for Counter-Based Ciphers in Encapsulating Security Payload (ESP)".

\[77\] RFC 9112: "HTTP/1.1".

\[78\] IETF RFC 9113: "HTTP/2".

\[79\] IETF RFC 9325: "Recommendations for Secure Use of Transport Layer Security (TLS) and Datagram Transport Layer Security (DTLS)".
...
For native IP-based protocols, security shall be provided at the network layer. The security protocols to be used at the network layer are the IETF defined IPsec security protocols as specified in RFC-4301 \[35\] .
...
When NDS/IP is applied, the ESP security protocol shall be used. IPsec ESP shall be supported according to RFC-4303 \[31\]. Extended sequence number may be supported. Usage guidance for the Implementation of Cryptographic Algorithm for ESP shall follow RFC-8221\[70\].
...
The implementation conformance requirements for ESP encryption transforms (including authenticated encryption transforms) in RFC 8221 \[69\] shall be followed.

Only the ESP encryption algorithms (including authenticated encryption algorithms) mentioned in RFC 8221 \[70\] or RFC 8750 \[76\] shall be used. Algorithms marked with "MUST" shall be supported. However, for IV generation, initiators may propose implicit IV variant of algorithms as defined in RFC 8750 \[76\], while negotiating the ESP encryption transforms, as they have higher performance.

### 5.3.4 Support of ESP authentication transforms

The implementation conformance requirements for ESP authentication transforms in RFC 8221 \[70\] shall be followed.

Only the ESP authentication algorithms mentioned in RFC 8221 \[70\] shall be used. Algorithms marked with "MUST" shall be supported. AES-GMAC with AES-128 shall be supported.
...
\- For CTR, GCM, CCM, ChaCha20-Poly1305 and GMAC mode: the IV field is 8 octets. The IV shall be generated in a manner that ensures uniqueness. The same IV and key combination shall not be used more than once. - It is explicitly not allowed to construct the IV from the encrypted data of the preceding encryption process. It is explicitly not allowed to use a random IV.

The previously common practice of constructing an IV in CBC mode from the encrypted data of the preceding encryption process means that the IV is disclosed before it is used. A predictable IV exposes IPsec to certain attacks irrespective of the strength of the underlying cipher algorithm. The first bullet point forbids this practice in the context of NDS/IP.

These requirements on CBC mode imply that the network elements shall have a capability to generate random data. RFC 4086 \[69\] gives guidelines for hardware and software pseudorandom number generators.
...
NOTE 1: Clause 6.2.1b of TS 33.310 \[30\] provides additional requirements to the general 3GPP IKEv2 profile when certificate based IKEv2 authentication is used.

NOTE 2: For implementation requirements and usage guidance for IKEv2, RFC 7296 \[43\] has been updated in RFC 8247 \[73\]. In this case, RFC 8247 \[73\] and the present document takes precedence over RFC 7296 \[43\].
...
An ephemeral private key shall be used in exactly one key establishment transaction and shall be destroyed (zeroized) as soon as possible.
...
\- Identification Payloads (IDi and IDr) shall not be used for the IKEv2 authentication but may be used for policy lookup.
...
NOTE 1: Recommendations for Secure Use of TLS and DTLS can be found in RFC 9325 \[79\] and RFC 9113 \[78\].

NOTE 2: DTLS 1.2 as specified in RFC 6347 \[49\] is based on TLS 1.2. DTLS 1.3 as specified in RFC 9147 \[75\] is based on TLS 1.3. Hence all requirements defined in this profile apply to DTLS protocol as well.
...
\- TLS 1.2 as specified in RFC 5246 \[50\] shall be supported. TLS 1.3 as specified in RFC 8446 \[66\] shall be supported. If DTLS is supported then DTLS 1.2 as specified in RFC 6347 \[49\] shall be supported and DTLS 1.3 as specified in RFC 9147 \[75\] should be supported.

**Other**

\- If the TLS connection is used to transport HTTP/2 over TLS, then the additional requirements specified in RFC 9113 \[78\] shall be followed.

\- If the TLS connection is used to transport HTTP over TLS as specified in RFC 9110 \[74\], then the client shall not establish a connection "upgraded to TLS Within HTTP/1.1" per RFC 9110 \[74\] and per RFC 9112 \[77\] but shall only establish the tunnel over a raw TCP connection.

## 6.2.2 Profiling for TLS 1.3

For TLS 1.3 the following restrictions and extensions shall apply:
...
\- Ffdhe2048 shall not be supported.

\- For HTTP/2 over TLS 1.3, then the additional requirements specified in section 9.2.3 of RFC 9113 \[78\] shall be followed.
...
\- The requirements given in sections 4.2 and 9.2 of TLS 1.3 RFC 8446 \[66\] and in RFC 9325 \[79\] shall be followed. In addition:

\- The TLS Certificate Status Request extension (i.e., "OCSP stapling") as defined in RFC 6066 \[57\] and RFC 8446 \[66\] should be supported.

\- For HTTP/2 over TLS 1.3, then the additional requirements specified in section 9.2.3 of RFC 9113 \[78\] shall be followed. Specifically, HTTP/2 servers shall not send post-handshake TLS 1.3 CertificateRequest messages and the prohibition on post-handshake authentication applies even if the client offered the "post_handshake_auth" TLS extension.
...
\- The following cipher suites are mandatory to support and recommended to use:

\- TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 as defined in RFC 5289 \[55\]

\- TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 as defined in RFC 5289 \[55\]
...
\- Only cipher suites with AEAD (e.g. GCM) and PFS (i.e., ECDHE) shall be supported.

**Diffie-Hellman groups**

\- For ECDHE, the curve secp256r1 (P-256) as defined in RFC 8422 \[71\] shall be supported, secp384r1 (P-384) as defined in RFC 8422 \[71\] should be supported. Except x25519, elliptic curve groups of less than 256 bits shall not be supported.

\- Finite field Diffie-Hellman (i.e. DHE) shall not be supported.
...
\- If pre-shared key (psk) cipher suites are implemented in TLS, then RFC 5489 \[64\] shall apply and the following cipher suites are mandatory to support and recommended to use:
...
The security considerations for the use of AES GCM in section 8.4 of RFC 7518 \[59\] shall be taken into account. In particular, the same key shall not be used more than 2<sup>32</sup> times and an IV value shall not be used more than once with the same key.
...
#### 6.3.2.2 N32 interface

Only AES GCM with a 128-bit or 256-bit key shall be used.
...
The "jwk" header parameter shall not be supported.

The "alg" header parameter value ES256 (ECDSA using P-256 and SHA-256) shall be supported.

The "none" "alg" header parameter value shall not be supported.

The "kid" header parameter shall be supported.

If the "kid" header parameter is used, the end point shall check that the indicated "alg" matches the one specified by the parameters.

#### 6.3.3.2 N32 interface

End points may establish the expected signing algorithm and associated keys out-of-band (e.g. N32-c) and use the "kid" header parameter to pass a key identifier.

If an end point has established a public key and algorithm out of band (e.g. N32-c) and the "kid" header parameter is not used, then the end point shall check the indicated "alg" header parameter against the established algorithm

#### 6.3.3.3 Client credentials assertion

The "x5u" header parameter shall be supported.

The "x5c" header parameter shall be supported.

#### 6.3.3.4 Access token

The "x5t#S256" header parameter should be supported.
...
This section details how NDS/IP shall be used to protect IMS protocols and interfaces. The network domain security for IMS in 3GPP2 networks shall be as specified in in Annex S.5 of TS 33.203\[10\].
...
| 12-2002 | SA_18 | SP-020720 | 0004 |  | Securing UTRAN/GERAN IP Transport interfaces and specifically the Iu interface with NDS/IP mechanisms (Implemented after Rel-5 CR 003 included) | 5.1.0 | 6.0.0 | SECNDSIP |
...
| 2020-07 | SA#88E | SP-200363 | 0070 | 1 | F | TLS 1.3 cipher suites | 16.4.0 |
| 2021-12 | SA#94e | SP-211379 | 0072 | \- | B | Security updates for algorithms and protocols for 33.210 | 17.0.0 |
| 2022-09 | SA#97e | SP-220888 | 0073 | 1 | F | Update IPSec references to rfc8221 | 17.1.0 |
| 2022-09 | SA#97e | SP-220888 | 0074 | 1 | F | Update IPSec reference from obsolete RFC 7296 to RFC 8247 | 17.1.0 |
| 2024-03 | \- | \- | \- | \- | \- | Update to Rel-18 version (MCC) | 18.0.0 |
| 2024-06 | SA#104 | SP-240656 | 0083 | 1 | F | HTTP RFC obsoleted by IETF RFC 9110 | 18.1.0 |
| 2025-01 | SA#106 | SP-241801 | 0084 |  | B | Updates to cryprographic profiles | 19.0.0 |
| 2025-06 | SA#108 | SP-250679 | 0087 | 1 | F | Correcting inconsistencies to clause 6.2.3 of 33.210 | 19.1.0 |
| 2025-09 | SA#109 | SP-251022 | 0092 | 1 | F | JWS profile requirements alignment by use case | 19.2.0 |
| 2025-09 | SA#109 | SP-251022 | 0094 | 1 | F | JWE profile requirements alignment by use case | 19.2.0 |
| 2026-01 | SA#110 | SP-251525 | 0098 | \- | A | Mandating AEAD ciphersuites for TLS 1.2 | 19.3.0 |
