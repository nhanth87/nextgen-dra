> **TS-23.003_Rel19_v7.0.0** — converted from official 3GPP archive.
> Source: https://www.3gpp.org/ftp/Specs/archive/23_series/23.003/23003-j70.zip
...
<thead>
<tr>
<th colspan="2">3GPP TS 23.003 V19.7.0 (2026-06)</th>
</tr>
</thead>
<tbody>
<tr>
...
1.1 References [14](#references)

1.1.1 Normative references [14](#normative-references)

1.1.2 Informative references [19](#informative-references)

1.2 Abbreviations [19](#abbreviations)

1.3 General comments to references [20](#general-comments-to-references)

1.4 Conventions on bit ordering [20](#conventions-on-bit-ordering)

2 Identification of mobile subscribers [21](#identification-of-mobile-subscribers)

2.1 General [21](#general)

2.2 Composition of IMSI [21](#composition-of-imsi)

2.2A Subscription Permanent Identifier (SUPI) [22](#a-subscription-permanent-identifier-supi)

2.2B Subscription Concealed Identifier (SUCI) [22](#b-subscription-concealed-identifier-suci)

2.3 Allocation and assignment principles [25](#allocation-and-assignment-principles)

2.4 Structure of TMSI [25](#structure-of-tmsi)

2.5 Structure of LMSI [26](#structure-of-lmsi)

2.6 Structure of TLLI [26](#structure-of-tlli)

2.7 Structure of P-TMSI Signature [27](#structure-of-p-tmsi-signature)

2.8 Globally Unique Temporary UE Identity (GUTI) [27](#globally-unique-temporary-ue-identity-guti)

2.8.1 Introduction [27](#introduction)

2.8.2 Mapping between Temporary and Area Identities for the EUTRAN and the UTRAN/GERAN based systems [28](#mapping-between-temporary-and-area-identities-for-the-eutran-and-the-utrangeran-based-systems)

2.8.2.0 Introduction [28](#introduction-1)

2.8.2.1 Mapping from GUTI to RAI, P-TMSI and P-TMSI signature [28](#mapping-from-guti-to-rai-p-tmsi-and-p-tmsi-signature)

2.8.2.1.1 Introduction [28](#introduction-2)

2.8.2.1.2 Mapping in the UE [28](#mapping-in-the-ue)

2.8.2.1.3 Mapping in the old MME [29](#mapping-in-the-old-mme)

2.8.2.2 Mapping from RAI and P-TMSI to GUTI [29](#mapping-from-rai-and-p-tmsi-to-guti)

2.8.2.2.1 Introduction [29](#introduction-3)

2.8.2.2.2 Mapping in the UE [29](#mapping-in-the-ue-1)

2.8.2.2.3 Mapping in the new MME [30](#mapping-in-the-new-mme)

2.9 Structure of the S-Temporary Mobile Subscriber Identity (S-TMSI) [30](#structure-of-the-s-temporary-mobile-subscriber-identity-s-tmsi)

2.10 5G Globally Unique Temporary UE Identity (5G-GUTI) [30](#g-globally-unique-temporary-ue-identity-5g-guti)

2.10.1 Introduction [30](#introduction-4)

2.10.2 Mapping between Temporary Identities for the 5GS and the E-UTRAN [31](#mapping-between-temporary-identities-for-the-5gs-and-the-e-utran)

2.10.2.0 Introduction [31](#introduction-5)

2.10.2.1 Mapping from 5G-GUTI to GUTI [31](#mapping-from-5g-guti-to-guti)

2.10.2.1.1 Introduction [31](#introduction-6)

2.10.2.1.2 Mapping in the UE [31](#mapping-in-the-ue-2)

2.10.2.1.3 Mapping in the old AMF [32](#mapping-in-the-old-amf)

2.10.2.2 Mapping from GUTI to 5G-GUTI [32](#mapping-from-guti-to-5g-guti)

2.10.2.2.1 Introduction [32](#introduction-7)

2.10.2.2.2 Mapping in the UE [32](#mapping-in-the-ue-3)

2.10.2.2.3 Mapping in the new AMF [33](#mapping-in-the-new-amf)

2.11 Structure of the 5G-S-Temporary Mobile Subscriber Identity (5G-S-TMSI) [33](#structure-of-the-5g-s-temporary-mobile-subscriber-identity-5g-s-tmsi)

2.12 Structure of the Truncated 5G-S-Temporary Mobile Subscriber Identity (Truncated 5G-S-TMSI) [33](#structure-of-the-truncated-5g-s-temporary-mobile-subscriber-identity-truncated-5g-s-tmsi)

3 Numbering plan for mobile stations [34](#numbering-plan-for-mobile-stations)

3.1 General [34](#general-1)

3.2 Numbering plan requirements [34](#numbering-plan-requirements)

3.3 Structure of Mobile Subscriber ISDN number (MSISDN) [34](#structure-of-mobile-subscriber-isdn-number-msisdn)

3.4 Mobile Station Roaming Number (MSRN) for PSTN/ISDN routeing [35](#mobile-station-roaming-number-msrn-for-pstnisdn-routeing)

3.5 Structure of Mobile Station International Data Number [36](#structure-of-mobile-station-international-data-number)

3.6 Handover Number [36](#handover-number)

3.7 Structure of an IP v4 address [36](#structure-of-an-ip-v4-address)

3.8 Structure of an IP v6 address [36](#structure-of-an-ip-v6-address)

4 Identification of location areas and base stations [36](#identification-of-location-areas-and-base-stations)

4.1 Composition of the Location Area Identification (LAI) [36](#composition-of-the-location-area-identification-lai)

4.2 Composition of the Routing Area Identification (RAI) [37](#composition-of-the-routing-area-identification-rai)

4.3 Base station identification [37](#base-station-identification)

4.3.1 Cell Identity (CI) and Cell Global Identification (CGI) [37](#cell-identity-ci-and-cell-global-identification-cgi)

4.3.2 Base Station Identify Code (BSIC) [38](#base-station-identify-code-bsic)

4.4 Regional Subscription Zone Identity (RSZI) [38](#regional-subscription-zone-identity-rszi)

4.5 Location Number [39](#location-number)

4.6 Composition of the Service Area Identification (SAI) [39](#composition-of-the-service-area-identification-sai)

4.7 Closed Subscriber Group [39](#closed-subscriber-group)

4.8 HNB Name [39](#hnb-name)

4.9 CSG Type [40](#csg-type)

4.10 HNB Unique Identity [40](#hnb-unique-identity)

4.11 HRNN [40](#hrnn)

5 Identification of MSCs, GSNs, location registers and CSSs [40](#identification-of-mscs-gsns-location-registers-and-csss)

5.1 Identification for routeing purposes [40](#identification-for-routeing-purposes)

5.2 Identification of HLR for HLR restoration application [41](#identification-of-hlr-for-hlr-restoration-application)

5.3 Identification of the HSS for SMS [41](#identification-of-the-hss-for-sms)

6 International Mobile Station Equipment Identity, Software Version Number and Permanent Equipment Identifier [41](#international-mobile-station-equipment-identity-software-version-number-and-permanent-equipment-identifier)

6.1 General [41](#general-2)

6.2 Composition of IMEI and IMEISV [42](#composition-of-imei-and-imeisv)

6.2.1 Composition of IMEI [42](#composition-of-imei)

6.2.2 Composition of IMEISV [42](#composition-of-imeisv)

6.3 Allocation principles [43](#allocation-principles)

6.4 Permanent Equipment Identifier (PEI) [43](#permanent-equipment-identifier-pei)

7 Identification of Voice Group Call and Voice Broadcast Call Entities [43](#identification-of-voice-group-call-and-voice-broadcast-call-entities)

7.1 Group Identities [43](#group-identities)

7.2 Group Call Area Identification [44](#group-call-area-identification)

7.3 Voice Group Call and Voice Broadcast Call References [44](#voice-group-call-and-voice-broadcast-call-references)

8 SCCP subsystem numbers [44](#sccp-subsystem-numbers)

8.1 Globally standardized subsystem numbers used for GSM/UMTS [45](#globally-standardized-subsystem-numbers-used-for-gsmumts)

8.2 National network subsystem numbers used for GSM/UMTS [45](#national-network-subsystem-numbers-used-for-gsmumts)

9 Definition of Access Point Name [45](#definition-of-access-point-name)

9A Definition of Data Network Name [46](#a-definition-of-data-network-name)

9.0 General [46](#general-3)

9.1 Structure of APN [46](#structure-of-apn)

9.1.1 Format of APN Network Identifier [46](#format-of-apn-network-identifier)

9.1.2 Format of APN Operator Identifier [47](#format-of-apn-operator-identifier)

9.2 Definition of the Wild Card APN [48](#definition-of-the-wild-card-apn)

9.2.1 Coding of the Wild Card APN [48](#coding-of-the-wild-card-apn)

9.3 Definition of Emergency APN [48](#definition-of-emergency-apn)

10 Identification of the Cordless Telephony System entities [48](#identification-of-the-cordless-telephony-system-entities)

10.1 General description of CTS‑MS and CTS‑FP Identities [48](#general-description-of-ctsms-and-ctsfp-identities)

10.2 CTS Mobile Subscriber Identities [48](#cts-mobile-subscriber-identities)

10.2.1 General [48](#general-4)

10.2.2 Composition of the CTSMSI [48](#composition-of-the-ctsmsi)

10.2.3 Allocation principles [49](#allocation-principles-1)

10.2.4 CTSMSI hexadecimal representation [49](#ctsmsi-hexadecimal-representation)

10.3 Fixed Part Beacon Identity [49](#fixed-part-beacon-identity)

10.3.1 General [49](#general-5)

10.3.2 Composition of the FPBI [49](#composition-of-the-fpbi)

10.3.2.1 FPBI general structure [49](#fpbi-general-structure)

10.3.2.2 FPBI class A [50](#fpbi-class-a)

10.3.2.3 FPBI class B [50](#fpbi-class-b)

10.3.3 Allocation principles [51](#allocation-principles-2)

10.4 International Fixed Part Equipment Identity [51](#international-fixed-part-equipment-identity)

10.4.1 General [51](#general-6)

10.4.2 Composition of the IFPEI [51](#composition-of-the-ifpei)

10.4.3 Allocation and assignment principles [51](#allocation-and-assignment-principles-1)

10.5 International Fixed Part Subscription Identity [52](#international-fixed-part-subscription-identity)

10.5.1 General [52](#general-7)

10.5.2 Composition of the IFPSI [52](#composition-of-the-ifpsi)

10.5.3 Allocation and assignment principles [52](#allocation-and-assignment-principles-2)

11 Identification of Localised Service Area [52](#identification-of-localised-service-area)

12 Identification of PLMN, RNC, Service Area, CN domain and Shared Network Area [53](#identification-of-plmn-rnc-service-area-cn-domain-and-shared-network-area)

12.1 PLMN Identifier [53](#plmn-identifier)

12.2 CN Domain Identifier [53](#cn-domain-identifier)

12.3 CN Identifier [53](#cn-identifier)

12.4 RNC Identifier [54](#rnc-identifier)

12.5 Service Area Identifier [54](#service-area-identifier)

12.6 Shared Network Area Identifier [54](#shared-network-area-identifier)

12.7 Stand-Alone Non-Public Network Identifier [54](#stand-alone-non-public-network-identifier)

12.7.1 Network Identifier (NID) [54](#network-identifier-nid)

12.7.2 NID of assignment mode 0 [55](#nid-of-assignment-mode-0)

12.7.3 Group ID for Network Selection (GIN) [55](#group-id-for-network-selection-gin)

13 Numbering, addressing and identification within the IP multimedia core network subsystem [56](#numbering-addressing-and-identification-within-the-ip-multimedia-core-network-subsystem)

13.1 Introduction [56](#introduction-8)

13.2 Home network domain name [56](#home-network-domain-name)

13.3 Private User Identity [57](#private-user-identity)

13.4 Public User Identity [57](#public-user-identity)

13.4A Wildcarded Public User Identity [58](#a-wildcarded-public-user-identity)

13.4B Temporary Public User Identity [58](#b-temporary-public-user-identity)

13.5 Public Service Identity (PSI) [59](#public-service-identity-psi)

13.5A Private Service Identity [59](#a-private-service-identity)

13.6 Anonymous User Identity [60](#anonymous-user-identity)

13.7 Unavailable User Identity [60](#unavailable-user-identity)

13.8 Instance-ID [60](#instance-id)

13.9 XCAP Root URI [60](#xcap-root-uri)

13.9.1 XCAP Root URI on Ut interface [60](#xcap-root-uri-on-ut-interface)

13.9.1.1 General [60](#general-8)

13.9.1.2 Format of XCAP Root URI [60](#format-of-xcap-root-uri)

13.10 Default Conference Factory URI for MMTel [61](#default-conference-factory-uri-for-mmtel)

13.11 Unknown User Identity [61](#unknown-user-identity)

13.12 Default WWSF URI [62](#default-wwsf-uri)

13.12.1 General [62](#general-9)

13.12.2 Format of the Default WWSF URI [62](#format-of-the-default-wwsf-uri)

13.13 IMEI based identity [62](#imei-based-identity)

14 Numbering, addressing and identification for 3GPP System to WLAN Interworking [63](#numbering-addressing-and-identification-for-3gpp-system-to-wlan-interworking)

14.1 Introduction [63](#introduction-9)

14.2 Home network realm [63](#home-network-realm)

14.3 Root NAI [63](#root-nai)

14.4 Decorated NAI [64](#decorated-nai)

14.4A Fast Re‑authentication NAI [64](#a-fast-reauthentication-nai)

14.5 Temporary identities [65](#temporary-identities)

14.6 Alternative NAI [65](#alternative-nai)

14.7 W-APN [65](#w-apn)

14.7.1 Format of W-APN Network Identifier [66](#format-of-w-apn-network-identifier)

14.7.2 Format of W-APN Operator Identifier [66](#format-of-w-apn-operator-identifier)

14.7.3 Alternative Format of W-APN Operator Identifier [67](#alternative-format-of-w-apn-operator-identifier)

14.8 Emergency Realm and Emergency NAI for Emergency Cases [67](#emergency-realm-and-emergency-nai-for-emergency-cases)

15 Identification of Multimedia Broadcast/Multicast Service [68](#identification-of-multimedia-broadcastmulticast-service)

15.1 Introduction [68](#introduction-10)

15.2 Structure of TMGI [68](#structure-of-tmgi)

15.3 Structure of MBMS SAI [69](#structure-of-mbms-sai)

15.4 Home Network Realm [69](#home-network-realm-1)

15.5 Addressing and identification for Bootstrapping MBMS Service Announcement [70](#addressing-and-identification-for-bootstrapping-mbms-service-announcement)

16 Numbering, addressing and identification within the GAA subsystem [70](#numbering-addressing-and-identification-within-the-gaa-subsystem)

16.1 Introduction [70](#introduction-11)

16.2 BSF address [70](#bsf-address)

17 Numbering, addressing and identification within the Generic Access Network [71](#numbering-addressing-and-identification-within-the-generic-access-network)

17.1 Introduction [71](#introduction-12)

17.2 Network Access Identifiers [71](#network-access-identifiers)

17.2.1 Home network realm [71](#home-network-realm-2)

17.2.2 Full Authentication NAI [72](#full-authentication-nai)

17.2.3 Fast Re‑authentication NAI [72](#fast-reauthentication-nai)

17.3 Node Identifiers [73](#node-identifiers)

17.3.1 Home network domain name [73](#home-network-domain-name-1)

17.3.2 Provisioning GANC-SEGW identifier [73](#provisioning-ganc-segw-identifier)

17.3.3 Provisioning GANC identifier [74](#provisioning-ganc-identifier)

18 Addressing and Identification for IMS Service Continuity and Single-Radio Voice Call Continuity [74](#addressing-and-identification-for-ims-service-continuity-and-single-radio-voice-call-continuity)

18.1 Introduction [74](#introduction-13)

18.2 CS Domain Routeing Number (CSRN) [74](#cs-domain-routeing-number-csrn)

18.3 IP Multimedia Routeing Number (IMRN) [75](#ip-multimedia-routeing-number-imrn)

18.4 Session Transfer Number (STN) [75](#session-transfer-number-stn)

18.5 Session Transfer Identifier (STI) [75](#session-transfer-identifier-sti)

18.6 Session Transfer Number for Single Radio Voice Call Continuity (STN-SR) [75](#session-transfer-number-for-single-radio-voice-call-continuity-stn-sr)

18.7 Correlation MSISDN [75](#correlation-msisdn)

18.8 Transfer Identifier for CS to PS Single Radio Voice Call Continuity (STI-rSR) [75](#transfer-identifier-for-cs-to-ps-single-radio-voice-call-continuity-sti-rsr)

18.9 Additional MSISDN [75](#additional-msisdn)

19 Numbering, addressing and identification for the Evolved Packet Core (EPC) [76](#numbering-addressing-and-identification-for-the-evolved-packet-core-epc)

19.1 Introduction [76](#introduction-14)

19.2 Home Network Realm/Domain [76](#home-network-realmdomain)

19.3 3GPP access to non-3GPP access interworking [76](#gpp-access-to-non-3gpp-access-interworking)

19.3.1 Introduction [76](#introduction-15)

19.3.2 Root NAI [77](#root-nai-1)

19.3.3 Decorated NAI [77](#decorated-nai-1)

19.3.4 Fast Re‑authentication NAI [78](#fast-reauthentication-nai-1)

19.3.5 Pseudonym Identities [79](#pseudonym-identities)

19.3.6 Emergency NAI for Limited Service State [80](#emergency-nai-for-limited-service-state)

19.3.7 Alternative NAI [80](#alternative-nai-1)

19.3.8 Keyname NAI [80](#keyname-nai)

19.3.9 IMSI-based Emergency NAI [81](#imsi-based-emergency-nai)

19.3.10 High Priority Access NAI [81](#high-priority-access-nai)

19.4 Identifiers for Domain Name System procedures [81](#identifiers-for-domain-name-system-procedures)

19.4.1 Introduction [81](#introduction-16)

19.4.2 Fully Qualified Domain Names (FQDNs) [82](#fully-qualified-domain-names-fqdns)

19.4.2.1 General [82](#general-10)

19.4.2.2 Access Point Name FQDN (APN-FQDN) [82](#access-point-name-fqdn-apn-fqdn)

19.4.2.2.1 Structure [82](#structure)

19.4.2.2.2 Void [83](#void)

19.4.2.2.3 Void [83](#void-1)

19.4.2.2.4 Void [83](#void-2)

19.4.2.3 Tracking Area Identity (TAI) [83](#tracking-area-identity-tai)

19.4.2.4 Mobility Management Entity (MME) [83](#mobility-management-entity-mme)

19.4.2.5 Routing Area Identity (RAI) - EPC [84](#routing-area-identity-rai---epc)

19.4.2.6 Serving GPRS Support Node (SGSN) within SGSN pool [84](#serving-gprs-support-node-sgsn-within-sgsn-pool)

19.4.2.7 Target RNC-ID for U-TRAN [84](#target-rnc-id-for-u-tran)

19.4.2.8 DNS subdomain for operator usage in EPC [85](#dns-subdomain-for-operator-usage-in-epc)

19.4.2.9 ePDG FQDN and Visited Country FQDN for non-emergency bearer services [85](#epdg-fqdn-and-visited-country-fqdn-for-non-emergency-bearer-services)

19.4.2.9.1 General [85](#general-11)

19.4.2.9.2 Operator Identifier based ePDG FQDN [85](#operator-identifier-based-epdg-fqdn)

19.4.2.9.3 Tracking/Location Area Identity based ePDG FQDN [86](#trackinglocation-area-identity-based-epdg-fqdn)

19.4.2.9.4 Visited Country FQDN [87](#visited-country-fqdn)

19.4.2.9.5 Replacement field used in DNS-based Discovery of regulatory requirements [87](#replacement-field-used-in-dns-based-discovery-of-regulatory-requirements)

19.4.2.9A ePDG FQDN for emergency bearer services [88](#a-epdg-fqdn-for-emergency-bearer-services)

19.4.2.9A.1 General [88](#a.1-general)

19.4.2.9A.2 Operator Identifier based Emergency ePDG FQDN [88](#a.2-operator-identifier-based-emergency-epdg-fqdn)

19.4.2.9A.3 Tracking/Location Area Identity based Emergency ePDG FQDN [88](#a.3-trackinglocation-area-identity-based-emergency-epdg-fqdn)

19.4.2.9A.4 Visited Country Emergency FQDN [89](#a.4-visited-country-emergency-fqdn)

19.4.2.9A.5 Replacement field used in DNS-based Discovery of regulatory requirements for emergency services [89](#a.5-replacement-field-used-in-dns-based-discovery-of-regulatory-requirements-for-emergency-services)

19.4.2.9A.6 Country based Emergency Numbers FQDN [89](#a.6-country-based-emergency-numbers-fqdn)

19.4.2.9A.7 Replacement field used in DNS-based Discovery of Emergency Numbers [90](#a.7-replacement-field-used-in-dns-based-discovery-of-emergency-numbers)

19.4.2.10 Global eNodeB-ID for eNodeB [90](#global-enodeb-id-for-enodeb)

19.4.2.11 Local Home Network identifier [90](#local-home-network-identifier)

19.4.2.12 UCMF [91](#ucmf)

19.4.2.13 PGW Set FQDN [91](#pgw-set-fqdn)

19.4.3 Service and Protocol service names for 3GPP [91](#service-and-protocol-service-names-for-3gpp)

19.5 Access Network Identity [93](#access-network-identity)

19.6 E-UTRAN Cell Identity (ECI) and E-UTRAN Cell Global Identification (ECGI) [93](#e-utran-cell-identity-eci-and-e-utran-cell-global-identification-ecgi)

19.6A NR Cell Identity (NCI) and NR Cell Global Identity (NCGI) [93](#a-nr-cell-identity-nci-and-nr-cell-global-identity-ncgi)

19.7 Identifiers for communications with packet data networks and applications [94](#identifiers-for-communications-with-packet-data-networks-and-applications)

19.7.1 Introduction [94](#introduction-17)

19.7.2 External Identifier [94](#external-identifier)

19.7.3 External Group Identifier [94](#external-group-identifier)

19.8 TWAN Operator Name [95](#twan-operator-name)

19.9 IMSI-Group Identifier [95](#imsi-group-identifier)

19.10 Presence Reporting Area Identifier (PRA ID) [95](#presence-reporting-area-identifier-pra-id)

19.11 Dedicated Core Networks Identifier [96](#dedicated-core-networks-identifier)

20 Addressing and Identification for IMS Centralized Services [96](#addressing-and-identification-for-ims-centralized-services)

20.1 Introduction [96](#introduction-18)

20.2 UE based solution [96](#ue-based-solution)

20.3 Network based solution [96](#network-based-solution)

20.3.1 General [96](#general-12)

20.3.2 Home network domain name [97](#home-network-domain-name-2)

20.3.3 Private User Identity [97](#private-user-identity-1)

20.3.4 Public User Identity [97](#public-user-identity-1)

20.3.5 Conference Factory URI [98](#conference-factory-uri)

21 Addressing and Identification for Dual Stack Mobile IPv6 (DSMIPv6) [98](#addressing-and-identification-for-dual-stack-mobile-ipv6-dsmipv6)

21.1 Introduction [98](#introduction-19)

21.2 Home Agent – Access Point Name (HA-APN) [98](#home-agent-access-point-name-ha-apn)

21.2.1 General [98](#general-13)

21.2.2 Format of HA-APN Network Identifier [98](#format-of-ha-apn-network-identifier)

21.2.3 Format of HA-APN Operator Identifier [99](#format-of-ha-apn-operator-identifier)
...
22.2.2 Format of ANDSF-SN [100](#format-of-andsf-sn)

23 Numbering, addressing and identification for the OAM System [100](#numbering-addressing-and-identification-for-the-oam-system)

23.1 Introduction [100](#introduction-21)

23.2 OAM System Realm/Domain [100](#oam-system-realmdomain)

23.3 Identifiers for Domain Name System procedures [101](#identifiers-for-domain-name-system-procedures-1)

23.3.1 Introduction [101](#introduction-22)

23.3.2 Fully Qualified Domain Names (FQDNs) [101](#fully-qualified-domain-names-fqdns-1)

23.3.2.1 General [101](#general-15)

23.3.2.2 Relay Node Vendor-Specific OAM System [101](#relay-node-vendor-specific-oam-system)

23.3.2.3 Multi-vendor eNodeB Plug-and Play Vendor-Specific OAM System [102](#multi-vendor-enodeb-plug-and-play-vendor-specific-oam-system)

23.3.2.3.1 General [102](#general-16)

23.3.2.3.2 Certification Authority server [102](#certification-authority-server)

23.3.2.3.3 Security Gateway [102](#security-gateway)

23.3.2.3.4 Element Manager [103](#element-manager)

24 Numbering, addressing and identification for Proximity-based Services (ProSe) [103](#numbering-addressing-and-identification-for-proximity-based-services-prose)

24.1 Introduction [103](#introduction-23)

24.2 ProSe Application ID [103](#prose-application-id)

24.2.1 General [103](#general-17)

24.2.2 Format of ProSe Application ID Name in ProSe Application ID [104](#format-of-prose-application-id-name-in-prose-application-id)

24.2.3 Format of PLMN ID in ProSe Application ID [104](#format-of-plmn-id-in-prose-application-id)

24.2.4 Usage of wild cards in place of PLMN ID in ProSe Application ID [105](#usage-of-wild-cards-in-place-of-plmn-id-in-prose-application-id)

24.2.5 Informative examples of ProSe Application ID [105](#informative-examples-of-prose-application-id)

24.2.6 Format of SNPN ID in ProSe Application ID [105](#format-of-snpn-id-in-prose-application-id)

24.3 ProSe Application Code [105](#prose-application-code)

24.3.1 General [105](#general-18)

24.3.2 Format of PLMN ID in ProSe Application Code [106](#format-of-plmn-id-in-prose-application-code)

24.3.3 Format of temporary identity in ProSe Application Code [106](#format-of-temporary-identity-in-prose-application-code)

24.3A ProSe Application Code Prefix [107](#a-prose-application-code-prefix)

24.3B ProSe Application Code Suffix [107](#b-prose-application-code-suffix)

24.4 EPC ProSe User ID [107](#epc-prose-user-id)

24.4.1 General [107](#general-19)

24.4.2 Format of EPC ProSe User ID [107](#format-of-epc-prose-user-id)

24.5 Home PLMN ProSe Function Address [107](#home-plmn-prose-function-address)

24.6 ProSe Restricted Code [108](#prose-restricted-code)

24.7 ProSe Restricted Code Prefix [108](#prose-restricted-code-prefix)

24.8 ProSe Restricted Code Suffix [108](#prose-restricted-code-suffix)

24.9 ProSe Query Code [108](#prose-query-code)

24.10 ProSe Response Code [108](#prose-response-code)

24.11 ProSe Discovery UE ID [108](#prose-discovery-ue-id)

24.11.1 General [108](#general-20)

24.11.2 Format of ProSe Discovery UE ID [109](#format-of-prose-discovery-ue-id)

24.12 ProSe UE ID [109](#prose-ue-id)

24.13 ProSe Relay UE ID [109](#prose-relay-ue-id)

24.14 User Info ID [109](#user-info-id)

24.15 Relay Service Code [109](#relay-service-code)

24.16 Discovery Group ID [109](#discovery-group-id)

24.17 Service ID [110](#service-id)

25 Identification of Online Charging System [110](#identification-of-online-charging-system)

25.1 Introduction [110](#introduction-24)

25.2 Home network domain name [110](#home-network-domain-name-3)

26 Numbering, addressing and identification for Mission Critical Services [111](#numbering-addressing-and-identification-for-mission-critical-services)

26.1 Introduction [111](#introduction-25)

26.2 Domain name for MC services confidentiality protection of MC services identities [111](#domain-name-for-mc-services-confidentiality-protection-of-mc-services-identities)

27 Numbering, addressing and identification for V2X [111](#numbering-addressing-and-identification-for-v2x)

27.1 Introduction [111](#introduction-26)

27.2 V2X Control Function FQDN [111](#v2x-control-function-fqdn)

27.2.1 General [111](#general-21)

27.2.2 Format of V2X Control Function FQDN [111](#format-of-v2x-control-function-fqdn)

28 Numbering, addressing and identification for 5G System (5GS) [112](#numbering-addressing-and-identification-for-5g-system-5gs)

28.1 Introduction [112](#introduction-27)

28.2 Home Network Domain [112](#home-network-domain)

28.3 Identifiers for Domain Name System procedures [112](#identifiers-for-domain-name-system-procedures-2)

28.3.1 Introduction [112](#introduction-28)

28.3.2 Fully Qualified Domain Names (FQDNs) [113](#fully-qualified-domain-names-fqdns-2)

28.3.2.1 General [113](#general-22)

28.3.2.2 N3IWF FQDN [113](#n3iwf-fqdn)

28.3.2.2.1 General [113](#general-23)

28.3.2.2.2 Operator Identifier based N3IWF FQDN [113](#operator-identifier-based-n3iwf-fqdn)

28.3.2.2.3 Tracking Area Identity based N3IWF FQDN [114](#tracking-area-identity-based-n3iwf-fqdn)

28.3.2.2.4 Visited Country FQDN for N3IWF [115](#visited-country-fqdn-for-n3iwf)

28.3.2.2.5 Replacement field used in DNS-based Discovery of regulatory requirements [116](#replacement-field-used-in-dns-based-discovery-of-regulatory-requirements-1)

28.3.2.2.6 FQDN for SNPN N3IWF [117](#fqdn-for-snpn-n3iwf)

28.3.2.2.7 Replacement field used in DNS-based Discovery of SNPN N3IWF for regulatory requirements [119](#replacement-field-used-in-dns-based-discovery-of-snpn-n3iwf-for-regulatory-requirements)

28.3.2.2.8 Prefixed Operator Identifier based N3IWF FQDN [119](#prefixed-operator-identifier-based-n3iwf-fqdn)

28.3.2.2.9 Prefixed Tracking Area Identity based N3IWF FQDN [120](#prefixed-tracking-area-identity-based-n3iwf-fqdn)

28.3.2.3 PLMN level and Home NF Repository Function (NRF) FQDN [120](#plmn-level-and-home-nf-repository-function-nrf-fqdn)

28.3.2.3.1 General [120](#general-27)

28.3.2.3.2 Format of NRF FQDN [121](#format-of-nrf-fqdn)

28.3.2.3.3 NRF URI [121](#nrf-uri)

28.3.2.4 Network Slice Selection Function (NSSF) FQDN [121](#network-slice-selection-function-nssf-fqdn)

28.3.2.4.1 General [121](#general-28)

28.3.2.4.2 Format of NSSF FQDN [121](#format-of-nssf-fqdn)

28.3.2.4.3 NSSF URI [122](#nssf-uri)

28.3.2.5 AMF Name [122](#amf-name)

28.3.2.6 5GS Tracking Area Identity (TAI) FQDN [122](#gs-tracking-area-identity-tai-fqdn)

28.3.2.7 AMF Set FQDN [123](#amf-set-fqdn)

28.3.2.8 AMF Instance FQDN [124](#amf-instance-fqdn)

28.3.2.9 SMF Set FQDN [124](#smf-set-fqdn)

28.3.2.10 Short Message Service Function (SMSF) FQDN [125](#short-message-service-function-smsf-fqdn)

28.3.2.11 5G DDNMF FQDN [125](#g-ddnmf-fqdn)

28.4 Information for Network Slicing [125](#information-for-network-slicing)

28.4.1 General [125](#general-29)

28.4.2 Format of the S-NSSAI [126](#format-of-the-s-nssai)

28.4.3 Ranges of S-NSSAIs [126](#ranges-of-s-nssais)

28.4.4 Network Slice Instance Identifier (NSI ID) [126](#network-slice-instance-identifier-nsi-id)

28.4.5 Network Slice Admission Control (NSAC) Service Area Identifier (SAI) [126](#network-slice-admission-control-nsac-service-area-identifier-sai)

28.5 NF FQDN Format for Inter PLMN Routing [127](#nf-fqdn-format-for-inter-plmn-routing)

28.5.1 General [127](#general-30)

28.5.2 Telescopic FQDN [127](#telescopic-fqdn)

28.6 5GS Tracking Area Identity (TAI) [127](#gs-tracking-area-identity-tai)

28.7 Network Access Identifier (NAI) [128](#network-access-identifier-nai)

28.7.1 Introduction [128](#introduction-29)

28.7.2 NAI format for SUPI [128](#nai-format-for-supi)

28.7.3 NAI format for SUCI [128](#nai-format-for-suci)

28.7.4 Emergency NAI for Limited Service State [129](#emergency-nai-for-limited-service-state-1)

28.7.5 Alternative NAI [130](#alternative-nai-2)

28.7.6 NAI used for 5G registration via trusted non-3GPP access [130](#nai-used-for-5g-registration-via-trusted-non-3gpp-access)

28.7.7 NAI used by N5CW devices via trusted non-3GPP access [131](#nai-used-by-n5cw-devices-via-trusted-non-3gpp-access)

28.7.7.0 General [131](#general-31)

28.7.7.1 Decorated NAI used for N5CW devices via trusted non-3GPP access [132](#decorated-nai-used-for-n5cw-devices-via-trusted-non-3gpp-access)

28.7.7.2 Decorated NAI used for N5CW devices via trusted non-3GPP access for SNPN [132](#decorated-nai-used-for-n5cw-devices-via-trusted-non-3gpp-access-for-snpn)

28.7.8 NAI format for 5G-GUTI [132](#nai-format-for-5g-guti)

28.7.9 Decorated NAI format for SUCI [133](#decorated-nai-format-for-suci)

28.7.9.1 General [133](#general-32)

28.7.9.2 Decorated NAI used for 5G NSWO [133](#decorated-nai-used-for-5g-nswo)

28.7.10 NAI format for UP-PRUK ID [135](#nai-format-for-up-pruk-id)

28.7.11 NAI format for CP-PRUK ID [135](#nai-format-for-cp-pruk-id)

28.7.12 NAI used for 5G NSWO [135](#nai-used-for-5g-nswo)

28.8 Generic Public Subscription Identifier (GPSI) [136](#generic-public-subscription-identifier-gpsi)

28.9 Internal-Group Identifier [136](#internal-group-identifier)

28.10 Presence Reporting Area Identifier (PRA ID) [137](#presence-reporting-area-identifier-pra-id-1)

28.11 CAG-Identifier [137](#cag-identifier)

28.12 NF Set Identifier (NF Set ID) [137](#nf-set-identifier-nf-set-id)

28.13 NF Service Set Identifier (NF Service Set ID) [138](#nf-service-set-identifier-nf-service-set-id)

28.14 Data Network Access Identifier (DNAI) [139](#data-network-access-identifier-dnai)

28.15 Global Cable Identifier (GCI) [139](#global-cable-identifier-gci)

28.15.1 Introduction [139](#introduction-30)

28.15.2 NAI format for SUPI containing a GCI [139](#nai-format-for-supi-containing-a-gci)

28.15.3 User Location Information for RG accessing the 5GC via W-5GCAN (HFC Node ID) [140](#user-location-information-for-rg-accessing-the-5gc-via-w-5gcan-hfc-node-id)

28.15.4 GCI [140](#gci)

28.15.5 NAI format for SUCI containing a GCI [140](#nai-format-for-suci-containing-a-gci)

28.16 Global Line Identifier (GLI) [140](#global-line-identifier-gli)

28.16.1 Introduction [140](#introduction-31)

28.16.2 NAI format for SUPI containing a GLI [140](#nai-format-for-supi-containing-a-gli)

28.16.3 User Location Information for RG accessing the 5GC via W-5GBAN [141](#user-location-information-for-rg-accessing-the-5gc-via-w-5gban)

28.16.4 GLI [141](#gli)

28.16.5 NAI format for SUCI containing a GLI [141](#nai-format-for-suci-containing-a-gli)

28.17 DNS subdomain for operator usage in 5GC [141](#dns-subdomain-for-operator-usage-in-5gc)

28.18 NF FQDN Format for Inter SNPN Routing [141](#nf-fqdn-format-for-inter-snpn-routing)

28.18.1 General [141](#general-33)

28.19 User Location Information for UE accessing to 5G-RG acting as a TNAP [142](#user-location-information-for-ue-accessing-to-5g-rg-acting-as-a-tnap)

28.20 LCS Identifiers [142](#lcs-identifiers)

28.20.1 General [142](#general-34)

28.20.2 LCS Session Identity [142](#lcs-session-identity)

28.20.2.1 LCS correlation identifier [142](#lcs-correlation-identifier)

28.20.2.2 Routing identifier [142](#routing-identifier)

28.20.2.3 Deferred routing identifier [142](#deferred-routing-identifier)

28.20.3 LCS User Plane Binding ID [142](#lcs-user-plane-binding-id)

28.20.4 LMF Routing Information [142](#lmf-routing-information)

28.21 MPQUIC Identifiers [143](#mpquic-identifiers)

28.21.1 General [143](#general-35)

28.21.2 Context ID [143](#context-id)

28.22 Format of Non-3GPP Device Identifier [143](#format-of-non-3gpp-device-identifier)

29 Numbering, addressing and identification for RACS [143](#numbering-addressing-and-identification-for-racs)

29.1 Introduction [143](#introduction-32)

29.2 UE radio capability ID [144](#ue-radio-capability-id)

30 Identification of 5GS Multicast and Broadcast Services [144](#identification-of-5gs-multicast-and-broadcast-services)

30.1 Introduction [144](#introduction-33)

30.2 Structure of TMGI [145](#structure-of-tmgi-1)

30.3 Structure of Area Session ID [145](#structure-of-area-session-id)

30.4 Structure of MBS Frequency Selection Area ID [145](#structure-of-mbs-frequency-selection-area-id)

30.5 Structure of Associated Session ID [146](#structure-of-associated-session-id)

31 Identification for Ambient IoT [146](#identification-for-ambient-iot)

31.1 Introduction [146](#introduction-34)

31.2 Structure of AIoT Device Permanent Identifier [146](#structure-of-aiot-device-permanent-identifier)

31.3 Structure of Filtering Information [147](#structure-of-filtering-information)

31.4 Structure of AIoT Area ID [149](#structure-of-aiot-area-id)

31.5 Structure of AIoT Device Temporary Identifier [150](#structure-of-aiot-device-temporary-identifier)

31.6 Structure of AIoT Device Temporary Identifier Information [150](#structure-of-aiot-device-temporary-identifier-information)

31.7 Structure of AIoT Identification Information [150](#structure-of-aiot-identification-information)

Annex A (informative): Colour Codes [151](#annex-a-informative-colour-codes)

A.1 Utilization of the BSIC [151](#a.1-utilization-of-the-bsic)

A.2 Guidance for planning [152](#a.2-guidance-for-planning)

A.3 Example of PLMN Colour Codes (NCCs) for the European region [152](#a.3-example-of-plmn-colour-codes-nccs-for-the-european-region)

Annex B (normative): IMEI Check Digit computation [154](#annex-b-normative-imei-check-digit-computation)

B.1 Representation of IMEI [154](#b.1-representation-of-imei)

B.2 Computation of CD for an IMEI [154](#b.2-computation-of-cd-for-an-imei)

B.3 Example of computation [154](#b.3-example-of-computation)

Annex C (normative): Naming convention [156](#annex-c-normative-naming-convention)

C.1 Routing Area Identities [156](#c.1-routing-area-identities)

C.2 GPRS Support Nodes [157](#c.2-gprs-support-nodes)

C.3 Target ID [157](#c.3-target-id)

Annex D (informative): Applicability and use of the ".3gppnetwork.org" domain name [157](#annex-d-informative-applicability-and-use-of-the-.3gppnetwork.org-domain-name)

Annex E (normative): Procedure for sub‑domain allocation [159](#annex-e-normative-procedure-for-subdomain-allocation)

Annex F (informative): Change history [161](#annex-f-informative-change-history)
...
\[80\] IETF RFC 9562: "Universally Unique IDentifiers (UUIDs)".
...
\[152\] 3GPP TS 23.369: "Architecture support for Ambient power-enabled Internet of Things; Stage 2".

\[153\] GS1 TDS Release 2.1: "EPC Tag Data Standard".

\[154\] IETF RFC 9484: "Proxying IP in HTTP".

\[155\] IETF draft-ietf-masque-connect-ethernet-07: "Proxying Ethernet in HTTP".

Editor's note: The above reference will be revised to RFC when finalized by IETF.

\[156\] 3GPP TS 24.502: " Access to the 3GPP 5G Core Network (5GCN) via Non-3GPP Access Networks (N3AN); Stage 3".

\[157\] 3GPP TS 33.369: " Security aspects of Ambient Internet of Things (AIoT) services for isolated private networks".
...
2\) Mobile Network Code (MNC) consisting of two or three digits for 3GPP network applications. The MNC identifies the home PLMN of the mobile subscription within its country of domicile, or it identifies together with MCC and NID the mobile subscription's SNPN. The length of the MNC (two or three digits) depends on the value of the MCC. A mixture of two and three digit geographic MNC codes within a single geographic MCC area is subject to local/regional regulations. If a mixture is applied, overlapped MNCs shall not be used; i.e.:

\- a three digit MNC shall not overlap with the same 2 first digits as another two digit MNC under the same geographic MCC (e.g. MNC 12 and MNC 123), and

\- a three digit MNC shall not start with 0, if another two digit MNC with the same digits exist in the same geographic MCC (e.g. MNC 012 and MNC 12).

NOTE 1: The mobility management entity in a VPLMN needs to be configured to know the deployment of a mixture of two and three digit MNC codes for a country which it has a roaming agreement.

NOTE 2: To reduce the configuration in the VPLMN, it is recommended to use different value ranges for the two digit MNCs, e.g. 01-89, and three digits, e.g. 900-999, if such deployment is required.
...
If no IMEI is available, the instance-id shall take the form of a string representation of a UUID as a URN as defined in IETF RFC 9562 \[80\]. An example of such an instance-id is as follows:
...
The structure of the W-APN shall follow the Name Syntax defined in IETF RFC 2181 \[18\], IETF RFC 1035 \[19\] and IETF RFC 1123 \[20\]. The W-APN consists of one or more labels.
...
The PLMN ID is placed before the ProSe Application ID Name as shown in Figure 24.2.1-1. The PLMN ID and the ProSe Application ID Name shall be separated by a dot.

Figure 24.2.1-1: Structure of ProSe Application ID

To support the 5G ProSe in SNPN(s), the SNPN ID is placed before the ProSe Application ID as shown in Figure 24.2.1-2. The SNPN ID and the ProSe Application ID Name shall be separated by a dot.

Figure 24.2.1-2: Structure of ProSe Application ID in SNPN(s)
...
### 24.2.6 Format of SNPN ID in ProSe Application ID

The SNPN ID shall uniquely define the SNPN of the Prose Function that has assigned the ProSe Application ID. The SNPN ID is composed of three labels which shall be separated by a dot as follows:

"mcc\<MCC\>.mnc\<MNC\>.nid\<NID\>"
...
\<NID\> contains NID (Network Identifier) that identifies the SNPN network.

The \<MCC\> and the \<MNC\> shall be represented by 3 digits. If there are only 2 significant digits in the MNC, one "0" digit is inserted at the left side of the MNC to form the \<MNC\> in the "mnc\<MNC\>" label. The \<NID\> shall be represented by 11 hexadecimal digits.

EXAMPLE: The \<SNPN ID\> comprises of \<PLMN ID \|\| NID\>. For MCC 345, MNC 12 and NID 456789ABCDE, it shall take the form "mcc345.mnc012.nid456789ABCDE".
...
\- The PLMN ID of the ProSe Function that assigned the ProSe Application Code defined in clause 24.3.2.

\- A temporary identity that corresponds to the ProSe Application ID Name defined in clause 24.3.3. The temporary identity is allocated by the ProSe Function and it may contain a metadata index. The internal structure of the temporary identity is not specified in 3GPP.
...
The PLMN-ID is composed of six parts:
...
\- N bit indicates whether the NID part is present:

\- 0 NID part is not included.

\- 1 NID part is included. It requires the E bit is set to 1.- E bit indicates whether the MCC and the MNC of the ProSe Function that has assigned the ProSe Application Code are included in the PLMN ID in ProSe Application Code, with the following mapping:

\- 0 Neither MCC nor MNC is included.

\- 1 MCC and MNC included.

\- Optional MCC and MNC parts. When present, the MCC and the MNC shall each have a fixed length of 10 bits and shall be coded as the binary representation of their decimal value.

\- Optional NID part to support the 5G ProSe in SNPN(s) as described in TS 23.304 \[143\]. When present, the NID is coded as the the binary representation of the hexadecimal digits of the NID (Network Identifier).
...
\- 160 bits when the E bit of the PLMN ID in the ProSe Application Code is set to 1 and the N bit is set to 0.

\- 116 bits when the E bit of the PLMN ID in the ProSe Application Code is set to 1 and the N bit is set to 1.
...
In this release, the MCC and the MNC of the ProSe Function that has assigned the ProSe Application Code are always included in the PLMN ID in ProSe Application Code.
...
The LCS Session Identity may contain an LCS correlation identifier, or a routing identifier, or a deferred routing identifier. The LCS Session Identity is used by Location supplementary services messages and LPP messages. The LCS Session Identity value is encoded as a variable length string with a minimum length of 1 octet and the maximum length of 255 octets, see clause 11.2.3 of TS 24.572 \[147\].

#### 28.20.2.1 LCS correlation identifier

The LCS correlation identifier is assigned either by an LMF, or AMF. It is used to identify a control plane LCS session between the UE and the LMF. The LCS correlation identifier is encoded as an alpha-numerical string (see also CorrelationID type definition in clause 6.1.6.3.2 of TS 29.572 \[149\]).

#### 28.20.2.2 Routing identifier

The routing identifier is assigned by an AMF. When LCS services are provisioned over the control plane, the AMF associates the routing identifier with the LCS correlation identifier. The routing identifier is used to identify the LMF. The routing identifier is encoded as a Universally Unique Identifier (UUID) version 4, see IETF RFC 9562 \[80\] and clause 6.1.6.2.10 and clause 6.1.6.2.12 in TS 29.518 \[148\] and also the NfInstanceId type definition in clause 5.3.2 of TS 29.571 \[129\].
...
### 28.20.3 LCS User Plane Binding ID

The LCS‑UP Binding ID is assigned by the LMF and used to associate the UE identity (SUPI and/or GUTI) with the LCS secured user plane connection between the UE and the LMF.

The LCS-UP binding ID is carried in the USER PLANE CONNECTION ESTABLISHMENT COMMAND message and used by the UE during the LCS-UP connection binding procedure as specified in clause 6.2.1.1 and clause 7.3.4.2 of TS 24.572 \[147\].

The LCS‑UP Binding ID is encoded as a variable length alpha-numerical string with a minimum length of 4 octets and a maximum length of 255 octets (see the LCS-UP Binding ID IE definition in clause 11.3.4 of TS 24.572 \[147\]).

### 28.20.4 LMF Routing Information

LMF Routing Information is also assigned by an LMF when triggering a UE to establish an LCS secured user-plane connection. It uniquely identifies a single LCS secured user-plane connection between the UE and LMF.

The LMF Routing Information is used to correlate NAS-level and service-based signalling related to the same LCS‑UP connection as follows:

\- The LMF Routing Information is included, by LMF and AMF,within service operations supporting LCS secured user-plane connection establishment, modification or relocation (see clause 5.2.2.5.2 of TS 29.572 \[149\]).

\- The AMF sets the Additional information IE (i.e the routing information) to the LMF Routing Information in the DOWNLINK NAS TRANSPORT message, if the payload container type IE is set to "UPP‑CMI container" (see clause 5.4.5.1 of TS 24.501 \[125\]).

NOTE: The Additional information IE (i.e the routing information) received by the UE is used by the UE when setting the Additional information IE (i.e the routing information) in the UPLINK NAS TRANSPORT message, if the Payload container type IE is set to "UPP‑CMI container".

\- In case of LMF relocation, the target LMF sets the LMF Routing Information IE (see clause 11.3.5 of TS 24.572 \[147\]) to the LMF Routing Information of the source LMF.

The LMF Routing Information is encoded as an IP address, UUID version 4, URI, or as a generic alpha-numerical string.
...
If MPQUIC functionality is used between the UE and the anchor UPF, the Context ID value determines:

\- the contents of the UDP Proxying Payload (see section 4 and section 5 of IETF RFC 9298 \[150\]) and also whether 3GPP specified Datagram mode 1 or mode 2 is used (see TS 24.193 \[151\]), when the MPQUIC-UDP steering functionality is used;

\- the contents of the IP Proxying Payload (see section 5 and section 6 of IETF RFC 9484 \[154\] and also whether 3GPP specified Datagram mode 1 or mode 2 is used (see TS 24.193 \[151\]), when the MPQUIC-IP steering functionality is used;

\- the contents of the Ethernet Proxying Payload (see section 5 and section 6 of IETF draft-ietf-masque-connect-ethernet-05 \[155\]) and also whether 3GPP specified Datagram mode 1 or mode 2 is used (see TS 24.193 \[151\]), when the MPQUIC-E steering functionality is used.

## 28.22 Format of Non-3GPP Device Identifier

The Non-3GPP Device Identifier is a string whose value is allocated by the operator or 3rd-party application which indicates the username of the device, see clause 3.1 in TS 23.501 \[119\].
...
# 31 Identification for Ambient IoT

## 31.1 Introduction

This clause describes the format of the parameters used for AmbientIoT. For further information on the use of the parameters, see clause 5 of TS 23.369 \[152\].

## 31.2 Structure of AIoT Device Permanent Identifier

The AIoT Device Permanent Identifier shall be composed as shown in Figure 31.2-1:

Figure 31.2-1: Structure of AIoT Device Permanent Identifier

The AIoT Device Permanent Identifier shall be coded as the binary representation of their value and is composed of the following parts:

1\) ID Type shall have a fixed length of 8 bits, including the following parts:

\- the bit 7 (the leftmost bit) indicates whether the PLMN ID part is present:
...
\- 00 Identification Information contains an Electronic Product Code (EPC), as defined in clause 14 of GS1 TDS Release 2.1 \[153\].

\- 01 Identification Information contains an unstructured information

\- 10 and 11 are spare for future use.

\- the bit 2 to bit 0 indicates the length of Identification Information.

\- 000 the length of Identification Information is 32 bits;

\- 001 the length of Identification Information is 64 bits;

\- 010 the length of Identification Information is 96 bits;

\- 011 the length of Identification Information is 128 bits;

\- 100 the length of Identification Information is 256 bits;

\- 101 the length of Identification Information is 496 bits;
...
> \- Optional Network Identifier (NID) as specified in clause 12.7.1. When present, NID shall have a fixed length of 44 bits. Bits 43 to 40 indicate the Assignment mode digit, bits 39 to 0 indicates the NID value.

\- Optional Third Party Identifier. When present, the Third Party Identifier shall have a fixed length of 24 bits.

3\) The length of Identification Information shall be 32 bits, 64 bits, 96 bits, 128 bits, 256 bits, or 496 bits.

## 31.3 Structure of Filtering Information

The Filtering Information is used to filter multiple AIoT Devices, and shall have a maximum length of 700 bits. It includes a list of filtering elements as specified in clause 5.8 of TS 23.369 \[152\], with the structure shown in Figure 31.3-1.

Figure 31.3-1: Structure of Filtering Information

The Filtering Information contains a field of Count of Filtering Element and includes at least one Filtering Element. The Filtering Information:

\- shall include at most one Filtering Element for each of the following component of AIoT Device Permanent Identifier: ID Type, PLMN ID, NID and Third Party Identifier.

\- may include multiple Filtering Elements for the following component of AIoT Device Permanent Identifier: Identification Information.

A Filtering Element within a Filtering Information shall be coded as the binary representation of its value which should be matched when performing filtering. If more than one Filtering Element is included within a Filtering Information, all Filtering Elements shall be matched.

The Filtering Information is composed of the following fields:

1\) The Count of Filtering Element field shall have a fixed length of 4 bits to indicate the number of Filtering Elements included in a Filtering Information.

2\) The Filtering Element field is composed of the following parts, with structure shown in Figure 31.3-2:

Figure 31.3-2: Structure of Filtering Element

1\) Filtering Type indicates which component of the AIoT Device Permanent Identifier is used to match the bitstring value of the Filtering Element, with the following mapping:

\- 000 indicate the Filtering Type for the Filtering Element is ID Type;

\- 001 indicate the Filtering Type for the Filtering Element is PLMN ID;

\- 010 indicate the Filtering Type for the Filtering Element is NID;

\- 011 indicate the Filtering Type for the Filtering Element is Third Party Identifier;

\- 100 indicate the Filtering Type for the Filtering Element is Identification Information;
...
2\) Filtering Element for ID Type: This field has a variant length of 7 to 14 bits, and is present only if the Filtering Type is set to 000. The structure is show in Figure 31.3-3.

> >
> Figure 31.3-3: Structure of Filtering Element for ID Type
...
\- Length consisting of 3 bits. It represents the length of bitstring value of the component to be compared.

\- Component Value consisting of 1 - 8 bits. It represents the bitstring value of the component to be compared.

NOTE: It is suggested that a Filtering Information does not only include ID Type Filter Element as Filter Information.

3\) Filtering Element for PLMN ID: This field shall have a fixed length of 24 bits, and is present only if the Filtering Type is set to 001.

4\) Filtering Element for NID: This filed shall have a fixed length of 44 bits, and is present only if the Filtering Type is set to 010.

5\) Filtering Element for Third Party Identifier: This field shall have a fixed length of 24 bits, and is present only if the Filtering Type is set to 011.

6\) Filtering Element for Identification Information: This field has a variant length of 19 to 514 bits, and is present only if the Filtering Type is set to 100.

It is used to filter the target devices where the specified portion of Identification Information matches the given bitstring. The structure is show in Figure 31.3-4.

> >
> Figure 31.3-4: Structure of Filtering Element for Identification Information

\- Offset consisting of 9 bits. It represents the position of the Identification Information's bitstring to be compared. Value 0 means the starting position is 1, and value 495 means the starting position is 496.

\- Length consisting of 9 bits. It represents the length of the bitstring value of the component to be compared.

\- Component Value consisting of 1 - 496 bits. It represents the bitstring value of the component to be compared.

## 31.4 Structure of AIoT Area ID

The AIoT Area ID consists of a Mobile Country Code (MCC), Mobile Network Code (MNC), and AIoT Area Code. It is composed as shown in figure 31.4-1.

Figure 31.4-1: Structure of the AIoT Area ID
...
## 31.5 Structure of AIoT Device Temporary Identifier

The AIoT Device Temporary Identifier (i.e. T-ID) as described in TS 33.369 \[157\] may be used as AIoT Device Identification Information in Inventory procedure if privacy protection is used.

## 31.6 Structure of AIoT Device Temporary Identifier Information

The AIoT Device Temporary Identifier Information shall be composed as shown in Figure 31.6-1:

Figure 31.6-1: Structure of AIoT Device Temporary Identifier Information

The AIoT Device Temporary Identifier Information shall be coded as the binary representation of the following parts:

1\) T-ID Type shall have a fixed length of 2 bit. It identifies the type of AIoT Device Temporary Identifier with following values:

\- 00 Stored T-ID type;

\- 01 Concealed T-ID type;

\- 10 Reserved;

\- 11 Reserved.

2\) Stored T-ID Update Indication part shall have a fixed length of 1 bit. It indicates how the stored T-ID to be updated, this field is present only if the T-ID Type is set to 0:

\- 0 Update without Command procedure;

\- 1 Update with Command procedure.

3\) AIoT Device Temporary Identifier as defined in clause 31.5 shall have a fixed length of 128 bits.

## 31.7 Structure of AIoT Identification Information

The AIoT Identification Information, as defined in clause 6.2.2 of TS 23.369 \[152\], includes either Filtering Information or an AIoT Device Permanent Identifier or an AIoT Device Temporary Identifier, and the structure is shown in Figure 31.7-1.

Figure 31.7-1: Structure of AIoT Identification Information

The AIoT Identification Information shall be coded as the binary representation of the following parts:

> 1\) AIoT Identification Information Type shall have a fixed length of 2 bits and indicates the value of Component of AIoT Identification Information:
>
> \- 00 indicate Component of AIoT Identification Information is Filtering Information;
>
> \- 01 indicate Component of AIoT Identification Information is AIoT Device Permanent Identifier;
>
> \- 10 indicate Component of AIoT Identification Information is AIoT Device Temporary Identifier Information;
>
> \- 11 Reserved.
>
> 2\) Component of AIoT Identification Information contains one of the following:
>
> \- Filtering Information as defined in clasue 31.3;
>
> \- AIoT Device Permanent Identifier as defined in clasue 31.2;
>
> \- AIoT Device Temporary Identifier Information as defined in clasue 31.6.
...
| 2024-09 | CT#105 |  | CP-242033 | 0703 | 1 | B | Format of SNPN ID description for 5G ProSe applications | 19.0.0 |
| 2024-12 | CT#106 |  | CP-243032 | 0704 | \- | F | Correction to wrong references | 19.1.0 |
| 2024-12 | CT#106 |  | CP-243041 | 0705 | 1 | B | Update ProSe App Code format to support 5G ProSe in NPNs | 19.1.0 |
| 2025-03 | CT#107 |  | CP-250039 | 0708 | 3 | B | Non-3GPP Device Identifier | 19.2.0 |
| 2025-06 | CT#108 |  | CP-251046 | 0713 | 4 | B | Definition of AIoT Device Permanent Identifier | 19.3.0 |
| 2025-09 | CT#109 |  | CP-252049 | 0716 | 1 | F | Mixture of two and three digit E.212 MNC codes within a single geographic MCC area shall instead be stated subject on local/regional regulations, i.e. shall be a national matter | 19.4.0 |
| 2025-09 | CT#109 |  | CP-252049 | 0719 | 1 | F | LCS Session Identity and LCS User Plane Connection/Binding ID | 19.4.0 |
| 2025-09 | CT#109 |  | CP-252051 | 0720 | 2 | B | Context ID for MPQUIC | 19.4.0 |
| 2025-12 | CT#110 |  | CP-253154 | 0715 | 7 | F | LCS identifiers | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253151 | 0724 | 1 | F | Update obsoleted RFC 4122 | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253160 | 0725 | 2 | F | Updates on filtering information | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253160 | 0726 | 1 | F | Corrections to Filtering Information | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253153 | 0728 |   | F | Correction of LCS User Plane Binding Identifier Definition and Reference | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253154 | 0729 | 4 | F | Define LCS-UP Connection Identifier for identifying secured user-plane connections between UE and LMF | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253160 | 0734 | 3 | B | Define AIoT Device Identification Information | 19.5.0 |
| 2025-12 | CT#110 |  | CP-253160 | 0736 | 1 | B | Update on the length of Identification Information | 19.5.0 |
| 2026-03 | CT#111 |  | CP-260030 | 0737 | \- | F | Fix Figure Numbering | 19.6.0 |
| 2026-03 | CT#111 |  | CP-260036 | 0738 | 1 | F | Correction and Cleanup on Ambient IoT Identifiers | 19.6.0 |
| 2026-06 | CT#112 |  | CP-261043 | 0741 | 1 | A | Update of IETF RFC reference for Decorated NAI format for SUCI | 19.7.0 |
| 2026-06 | CT#112 |  | CP-261054 | 0739 | \- | F | Updates on NID for AIoT identifier | 19.7.0 |
| 2026-06 | CT#112 |  | CP-261054 | 0742 | \- | F | AIoT Device Temporary Identifier correction | 19.7.0 |
